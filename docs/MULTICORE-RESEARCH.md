...
write-back, on both sides of the shared capture cell since #8440) are
the rules RC's lack of a cycle collector rests on
(`RC-PERCEUS-PLAN.md`, `CELL-TYPE-PLAN.md`).
Nothing about message passing may reopen a vector (e.g. a mailbox must not be a value a
