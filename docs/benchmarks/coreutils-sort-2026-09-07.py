...
"""Archived sort experiment for #8822; run only in a disposable Linux /bench.

Place native -O binaries at /bench/sort-before and /bench/sort and the uutils
...
See ../COREUTILS-SORT-2026-09-07.md for build and measurement details.
"""
...
for binary in [root / 'sort-before', root / 'sort', Path('/usr/bin/sort'), root / 'uutils/coreutils']:
