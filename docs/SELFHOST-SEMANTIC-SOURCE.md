...
Measured against the whole loaded self-hosted compiler, 6,546 of its 7,759
...
The leaves are now led by callees with no semantic contract (743), a closure
capturing a reference (246), a binding whose type is not its value's (75), a
