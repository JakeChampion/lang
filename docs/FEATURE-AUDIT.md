...
| `match` (exhaustiveness checked) | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | payload binding, comma-separated arms, guards (`when`), named-field patterns, variant or-patterns (`A \| B => …`, [#2698](https://github.com/JakeChampion/lang/issues/2698)) |
| `match` as expression | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | |
