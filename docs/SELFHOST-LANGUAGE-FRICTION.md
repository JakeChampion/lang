...
| Closures / lambdas | Capturing and escaping lambdas and nested named functions | **118**: 105 nested named functions across 5 modules, plus 13 arrow lambdas across 4 modules. Capture-contract integration removes two reconstruction visitors and adds the AST splicer identity hook. | pinned |
