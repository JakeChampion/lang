...
| Closures / lambdas | Capturing and escaping lambdas and nested named functions | **122**: 109 nested named functions across 5 modules, plus 13 arrow lambdas across 4 modules. Scalar identifier counting adds three visitors that capture the queried name. | pinned |
