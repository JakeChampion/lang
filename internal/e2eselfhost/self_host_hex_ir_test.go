...
var hexIRCases = []struct {
	...
	{"encode-len", `return hex_encode("hi").len();`},                   // "6869" -> 4
	{"encode-digit", `return hex_encode("A")[0] as i32;`},              // 0x41 -> '4' = 52
	{"decode-len", `return hex_decode("6869").len();`},                 // -> "hi" len 2
	{"decode-char", `return hex_decode("7a")[0] as i32;`},              // -> 'z' = 122
	{"roundtrip", `return hex_decode(hex_encode("Hi"))[0] as i32;`},    // 'H' = 72
	{"roundtrip-len", `return hex_decode(hex_encode("hello")).len();`}, // 5
}
