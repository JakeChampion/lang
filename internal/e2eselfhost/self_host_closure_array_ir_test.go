...
var closureArrayIRCases = []struct {
	...
	{"local-elem-scalar-cap", `function main(): i32 { var n = 42; var f: () => i32 = (): i32 => { return n; }; var fs: (() => i32)[] = [f]; return fs[0](); }`, 42},
	// ARRAY capture through the same shape (the capture is itself a pointer).
	{"local-elem-array-cap", `function main(): i32 { var a: i32[] = [42, 1]; var f: () => i32 = (): i32 => { return a[0]; }; var fs: (() => i32)[] = [f]; return fs[0](); }`, 42},
