...
var interpStdlibModloadCases = []struct {
	...
	{"bsd-sum", "function main(): i32 {\n  if (__bsd_sum(\"ab\", 0) != 32914) { return 1; }\n  if (__bsd_sum(\"\", 70000) != 4464) { return 2; }\n  return 7;\n}\n"},
	...
	// CARRIES a crc in — so an empty string must hand back exactly what it
	// was given, and cutting a string in two must fold to the same answer as
	// one call. Values from the Go oracle in internal/e2e/crc32_cksum_test.go.
	{"crc32-cksum", "function main(): i32 {\n  if (__crc32_cksum(0, \"\") != 0) { return 1; }\n  if (__crc32_cksum(12345, \"\") != 12345) { return 2; }\n  if (__crc32_cksum(0, \"hello world\") != 1937437358) { return 3; }\n  if (__crc32_cksum(0 - 1, \"x\") != 0 - 2001448981) { return 4; }\n  if (__crc32_cksum(__crc32_cksum(0, \"hello \"), \"world\") != 1937437358) { return 5; }\n  return 7;\n}\n"},
	...
	{"array-closure-methods", "import \"std/array\";\nfunction main(): i32 {\n  var xs: i32[] = [3, 1, 2];\n  var ys: i32[] = xs.map((v: i32): i32 => { return v * 2; });\n  if (ys.len() != 3 || ys[0] != 6) { return 1; }\n  var big: i32[] = ys.filter((v: i32): boolean => { return v > 3; });\n  if (big.len() != 2) { return 2; }\n  var total: i32 = xs.fold(0, (acc: i32, v: i32): i32 => { return acc + v; });\n  if (total != 6) { return 3; }\n  return 7;\n}\n"},
	{"array-predicate-methods", "import \"std/array\";\nfunction main(): i32 {\n  var xs: i32[] = [3, 1, 2];\n  if (xs.is_empty()) { return 1; }\n  if (!xs.any((v: i32): boolean => { return v == 2; })) { return 2; }\n  if (xs.all((v: i32): boolean => { return v > 2; })) { return 3; }\n  if (xs.count_where((v: i32): boolean => { return v > 1; }) != 2) { return 4; }\n  match (xs.first()) { Some(v) => { if (v != 3) { return 5; } }, None => { return 6; } }\n  match (xs.find((v: i32): boolean => { return v == 1; })) { Some(v) => { if (v != 1) { return 8; } }, None => { return 9; } }\n  return 7;\n}\n"},
	...
	{"array-index-of-generic", "import \"std/array\";\nfunction main(): i32 {\n  var xs: i32[] = [3, 1, 2];\n  match (xs.index_of(1)) { Some(i) => { if (i != 1) { return 1; } }, None => { return 1; } }\n  match (xs.index_of(9)) { Some(_) => { return 2; }, None => {} }\n  if (!xs.contains(2)) { return 3; }\n  if (xs.contains(9)) { return 4; }\n  var bs: u8[] = [7 as u8, 8 as u8];\n  match (bs.index_of(8 as u8)) { Some(i) => { if (i != 1) { return 5; } }, None => { return 5; } }\n  if (!bs.contains(7 as u8)) { return 6; }\n  var ws: string[] = [\"a\", \"bb\"];\n  match (ws.index_of(\"bb\")) { Some(i) => { if (i != 1) { return 8; } }, None => { return 8; } }\n  match (ws.index_of(\"zz\")) { Some(_) => { return 9; }, None => {} }\n  return 7;\n}\n"},
