...
func TestSelfHostIRKindRegistry(t *testing.T) {
	...
	// via kind_name, the 47 extension tags by name — so the round trip this
	...
	// proves every one of the 237 tags round-tripped AND that no near miss
