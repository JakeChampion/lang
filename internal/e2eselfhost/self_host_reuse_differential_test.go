...
var reuseDifferentialCases = []struct {
	...
	{"own-param-donor-string-field-detector", `struct P { s: string, n: i32 } function f(own d: P): i32 { var u: i32 = d.n + d.s.len(); var c = P { s: "fresh-literal-payload", n: u + 20 }; var s: i32 = c.n + c.s.len(); if (s != 61) { return 99; } return __rc_underflow(); } function main(): i32 { return f(P { s: "abcdefghij-longer", n: 3 }); }`, 0, "call __fn___fern_alloc_reuse"},
	...
	{"own-param-self-overwrite-string-field-detector", `struct P { s: string, n: i32 } function f(own d: P): i32 { var c = P { ...d, s: "override-literal-payload" }; var s: i32 = c.n + c.s.len(); if (s != 27) { return 99; } return __rc_underflow(); } function main(): i32 { return f(P { s: "abcdefghij-longer", n: 3 }); }`, 0, "call __fn___fern_alloc_reuse"},
	...
	{"own-param-return-update-enum-field", `enum E { A(i32), B(i32) } struct Q { e: E, n: i32 } function bumpq(own p: Q): Q { return Q { ...p, n: p.n + 1 }; } function main(): i32 { var q: Q = bumpq(Q { e: A(4), n: 3 }); var r: i32 = q.n; match (q.e) { A(v) => { r = r + v; }, B(v) => { r = r + v * 3; } } if (r != 8) { return 99; } return __rc_underflow(); }`, 0, "call __fn___fern_alloc_reuse"},
	...
	{"fn-field-self-overwrite", `struct H { f: (i32) => i32, id: i32 } function main(): i32 { var d: H = H { f: (x: i32): i32 => { return x + 3; }, id: 1 }; var c: H = H { ...d, f: (x: i32): i32 => { return x * 4; } }; if (__rc_underflow() != 0) { return 99; } return c.f(5) + c.id; }`, 21, "call __fn___fern_alloc_reuse"},
	{"fn-field-carried-copy", `struct H { f: (i32) => i32, id: i32 } function main(): i32 { var d: H = H { f: (x: i32): i32 => { return x + 3; }, id: 1 }; var c: H = H { ...d, id: 7 }; if (__rc_underflow() != 0) { return 99; } return c.f(5) + c.id; }`, 15, "call __fn___fern_alloc_reuse"},
...
func TestSelfHostStrarrReuseExclusionX86_64(t *testing.T) {
	...
	cases := []struct {
		...
		{"aliased-fn-donor-field", `struct H { f: (i32) => i32, id: i32 } function main(): i32 { var g = (x: i32): i32 => { return x * 2; }; var a: H = H { f: g, id: 1 }; var s1: i32 = a.f(5) + a.id; var b: H = H { f: (x: i32): i32 => { return x + 1; }, id: 2 }; var live: i32 = g(3); if (__rc_underflow() != 0) { return 99; } return s1 + b.f(5) + b.id + live; }`, 25},
		{"aliased-fn-override", `struct H { f: (i32) => i32, id: i32 } function main(): i32 { var g = (x: i32): i32 => { return x * 2; }; var d: H = H { f: (x: i32): i32 => { return x + 1; }, id: 1 }; var c: H = H { ...d, f: g, id: 2 }; var live: i32 = g(3); if (__rc_underflow() != 0) { return 99; } return c.f(5) + c.id + live; }`, 18},
		...
		{"aliased-string-own-override", `struct P { s: string, n: i32 } function f(own d: P): i32 { var t: string = "aliased-local-payload"; var c = P { ...d, s: t }; return c.n + c.s.len() + t.len(); } function main(): i32 { if (f(P { s: "abcdefghij-longer", n: 3 }) != 45) { return 98; } return __rc_underflow(); }`, 0},
		{"unrouted-string-own-donor", `struct P { s: string, n: i32 } function get(x: P): string { return x.s; } function f(own d: P): i32 { var u: i32 = d.n; var c = P { ...d, s: "override-literal-payload" }; return c.n + c.s.len() + u; } function main(): i32 { var h: P = P { s: "abcdefghij-longer", n: 3 }; var r: i32 = f(P { s: h.s, n: 4 }); var g: string = get(h); if (r + g.len() != 49) { return 98; } return __rc_underflow(); }`, 0},
