...
var reuseDifferentialCases = []struct {
	...
	{"cross-struct-callret-donor-detector", `struct P { x: i32, y: i32 } function mk(a: i32): P { return P { x: a, y: a + 1 }; } function main(): i32 { var one: i32 = 1; var d: P = mk(3); var u: i32 = d.x + d.y; var c: P = P { x: 10 * one, y: 20 }; var s: i32 = c.x + c.y + u; if (s != 37) { return 99; } return __rc_underflow_count(); }`, 0, "call __fn___fern_alloc_reuse"},
	...
	{"own-param-donor-detector", `struct P { x: i32, y: i32 } function bump(own d: P): i32 { var u: i32 = d.x + d.y; var c = P { x: 10, y: 20 }; var s: i32 = c.x + c.y + u; if (s != 37) { return 99; } return __rc_underflow_count(); } function main(): i32 { return bump(P { x: 3, y: 4 }); }`, 0, "call __fn___fern_alloc_reuse"},
	...
	{"own-param-donor-array-detector", `struct H { id: i32, items: i32[] } function bump(own d: H): i32 { var u: i32 = d.id + d.items[0]; var c = H { id: 5, items: [7, 8, 9] }; var s: i32 = c.id + c.items[0] + c.items[2] + u; if (s != 32) { return 99; } return __rc_underflow_count(); } function main(): i32 { return bump(H { id: 1, items: [10, 20] }); }`, 0, "call __fn___fern_alloc_reuse"},
	...
	{"own-param-donor-tuple-field-detector", `struct T2 { id: i32, t: (i32, i32) } function f(own d: T2): i32 { var u: i32 = d.id + d.t.0; var c = T2 { id: 10, t: (7, 8) }; var s: i32 = c.id + c.t.1 + u; if (s != 22) { return 99; } return __rc_underflow_count(); } function main(): i32 { return f(T2 { id: 3, t: (1, 2) }); }`, 0, "call __fn___fern_alloc_reuse"},
	...
	{"own-param-funcupdate-tuple-carried-detector", `struct T2 { id: i32, t: (i32, i32) } function f(own d: T2): i32 { var c = T2 { ...d, id: 10 }; var s: i32 = c.id + c.t.0 + c.t.1; if (s != 13) { return 99; } return __rc_underflow_count(); } function main(): i32 { return f(T2 { id: 3, t: (1, 2) }); }`, 0, "call __fn___fern_alloc_reuse"},
	...
	// var-bound self-overwrite (`var c = T { ...own_d, f }`) and the return-position
	// update (`return T { ...own_p, f }`) all fire.
	{"own-param-donor-string-field", `struct P { s: string, n: i32 } function f(own d: P): i32 { var u: i32 = d.n + d.s.len(); var c = P { s: "fresh-literal-payload", n: u + 20 }; return c.n + c.s.len(); } function main(): i32 { return f(P { s: "abcdefghij-longer", n: 3 }); }`, 61, "call __fn___fern_alloc_reuse"},
	{"own-param-donor-string-field-detector", `struct P { s: string, n: i32 } function f(own d: P): i32 { var u: i32 = d.n + d.s.len(); var c = P { s: "fresh-literal-payload", n: u + 20 }; var s: i32 = c.n + c.s.len(); if (s != 61) { return 99; } return __rc_underflow_count(); } function main(): i32 { return f(P { s: "abcdefghij-longer", n: 3 }); }`, 0, "call __fn___fern_alloc_reuse"},
	{"own-param-donor-enum-field", `enum E { A(i32), B(i32) } struct Q { e: E, n: i32 } function f(own d: Q): i32 { var u: i32 = d.n; match (d.e) { A(v) => { u = u + v; }, B(v) => { u = u + v * 2; } } var c = Q { e: B(5), n: u + 20 }; var r: i32 = c.n; match (c.e) { A(v) => { r = r + v; }, B(v) => { r = r + v * 3; } } return r; } function main(): i32 { return f(Q { e: A(4), n: 3 }); }`, 42, "call __fn___fern_alloc_reuse"},
	{"own-param-donor-enum-field-detector", `enum E { A(i32), B(i32) } struct Q { e: E, n: i32 } function f(own d: Q): i32 { var u: i32 = d.n; match (d.e) { A(v) => { u = u + v; }, B(v) => { u = u + v * 2; } } var c = Q { e: B(5), n: u + 20 }; var r: i32 = c.n; match (c.e) { A(v) => { r = r + v; }, B(v) => { r = r + v * 3; } } if (r != 42) { return 99; } return __rc_underflow_count(); } function main(): i32 { return f(Q { e: A(4), n: 3 }); }`, 0, "call __fn___fern_alloc_reuse"},
	{"own-param-self-overwrite-string-field", `struct P { s: string, n: i32 } function f(own d: P): i32 { var c = P { ...d, s: "override-literal-payload" }; return c.n + c.s.len(); } function main(): i32 { return f(P { s: "abcdefghij-longer", n: 3 }); }`, 27, "call __fn___fern_alloc_reuse"},
	{"own-param-self-overwrite-string-field-detector", `struct P { s: string, n: i32 } function f(own d: P): i32 { var c = P { ...d, s: "override-literal-payload" }; var s: i32 = c.n + c.s.len(); if (s != 27) { return 99; } return __rc_underflow_count(); } function main(): i32 { return f(P { s: "abcdefghij-longer", n: 3 }); }`, 0, "call __fn___fern_alloc_reuse"},
	{"own-param-self-overwrite-enum-field", `enum E { A(i32), B(i32) } struct Q { e: E, n: i32 } function f(own d: Q): i32 { var c = Q { ...d, e: B(5) }; var r: i32 = c.n; match (c.e) { A(v) => { r = r + v; }, B(v) => { r = r + v * 3; } } return r; } function main(): i32 { return f(Q { e: A(4), n: 3 }); }`, 18, "call __fn___fern_alloc_reuse"},
	{"own-param-return-update-enum-field", `enum E { A(i32), B(i32) } struct Q { e: E, n: i32 } function bumpq(own p: Q): Q { return Q { ...p, n: p.n + 1 }; } function main(): i32 { var q: Q = bumpq(Q { e: A(4), n: 3 }); var r: i32 = q.n; match (q.e) { A(v) => { r = r + v; }, B(v) => { r = r + v * 3; } } if (r != 8) { return 99; } return __rc_underflow_count(); }`, 0, "call __fn___fern_alloc_reuse"},
	{"own-param-donor-nested-detector", `struct Inner { a: i32, b: i32 } struct Outer { id: i32, inner: Inner } function bump(own d: Outer): i32 { var u: i32 = d.id + d.inner.a; var c = Outer { id: 5, inner: Inner { a: 7, b: 8 } }; var s: i32 = c.id + c.inner.a + c.inner.b + u; if (s != 23) { return 99; } return __rc_underflow_count(); } function main(): i32 { return bump(Outer { id: 1, inner: Inner { a: 2, b: 3 } }); }`, 0, "call __fn___fern_alloc_reuse"},
	...
	{"own-param-selfoverwrite-carried-detector", `struct H { id: i32, items: i32[] } function bump(own d: H): i32 { var c = H { ...d, id: 5 }; var s: i32 = c.id + c.items[0] + c.items[1]; if (s != 35) { return 99; } return __rc_underflow_count(); } function main(): i32 { return bump(H { id: 1, items: [10, 20] }); }`, 0, "call __fn___fern_alloc_reuse"},
	...
	{"self-overwrite-callret-base-detector", `struct P { x: i32, y: i32 } function mk(a: i32): P { return P { x: a, y: a + 1 }; } function main(): i32 { var d: P = mk(3); var c: P = P { ...d, x: 10 }; var s: i32 = c.x + c.y; if (s != 14) { return 99; } return __rc_underflow_count(); }`, 0, "call __fn___fern_alloc_reuse"},
	...
	{"cross-type-class-pairing-detector", `struct A { n: i32, xs: i32[] } struct B { ys: i32[], m: i32 } function main(): i32 { var d = A { n: 3, xs: [10, 20] }; var u: i32 = d.n + d.xs[0]; var c = B { ys: [7, 8, 9], m: 2 }; var s: i32 = c.ys[2] + c.m + u; if (s != 24) { return 99; } return __rc_underflow_count(); }`, 0, "call __fn___fern_alloc_reuse"},
	...
	{"self-overwrite-enum-override-detector", `enum St { On(i32), Off } struct M { tag: i32, st: St } function main(): i32 { var d = M { tag: 1, st: On(5) }; var c = M { ...d, st: On(9) }; var r: i32 = 0; match (c.st) { On(v) => { r = v + c.tag; }, Off => { r = 0; } } if (r != 10) { return 99; } return __rc_underflow_count(); }`, 0, "call __fn___fern_alloc_reuse"},
	{"self-overwrite-enum-carried-detector", `enum St { On(i32), Off } struct M { tag: i32, st: St } function main(): i32 { var d = M { tag: 1, st: On(5) }; var c = M { ...d, tag: 2 }; var r: i32 = 0; match (c.st) { On(v) => { r = v + c.tag; }, Off => { r = 0; } } if (r != 7) { return 99; } return __rc_underflow_count(); }`, 0, "call __fn___fern_alloc_reuse"},
	...
	{"self-overwrite-string-override-detector", `struct N { id: i32, name: string } function main(): i32 { var d = N { id: 1, name: "ab" + "c" }; var c = N { ...d, name: "wxyz" + "q" }; var s: i32 = c.name.len() as i32 + c.id; if (s != 6) { return 99; } return __rc_underflow_count(); }`, 0, "call __fn___fern_alloc_reuse"},
	{"self-overwrite-string-carried-detector", `struct N { id: i32, name: string } function main(): i32 { var d = N { id: 1, name: "ab" + "c" }; var c = N { ...d, id: 2 }; var s: i32 = c.name.len() as i32 + c.id; if (s != 5) { return 99; } return __rc_underflow_count(); }`, 0, "call __fn___fern_alloc_reuse"},
	{"cross-struct-string-field-detector", `struct N { id: i32, name: string } function main(): i32 { var d = N { id: 1, name: "ab" + "c" }; var u: i32 = d.name.len() as i32 + d.id; var c = N { id: 2, name: "wxyz" + "q" }; var s: i32 = c.name.len() as i32 + c.id + u; if (s != 11) { return 99; } return __rc_underflow_count(); }`, 0, "call __fn___fern_alloc_reuse"},
	...
	{"self-overwrite-map-carried-detector", `struct P { id: i32, m: Map[i32, i32] } function main(): i32 { var d = P { id: 1, m: Map { 1: 10 } }; var c = P { ...d, id: 2 }; var s: i32 = c.m.get_or(1, 0) + c.id; if (s != 12) { return 99; } return __rc_underflow_count(); }`, 0, "call __fn___fern_alloc_reuse"},
	...
	{"self-overwrite-map-override-detector", `struct P { id: i32, m: Map[i32, i32] } function main(): i32 { var d = P { id: 1, m: Map { 1: 10 } }; var c = P { ...d, m: Map { 1: 39 } }; var s: i32 = c.m.get_or(1, 0) + c.id; if (s != 40) { return 99; } return __rc_underflow_count(); }`, 0, "call __fn___fern_alloc_reuse"},
	{"cross-struct-map-field-detector", `struct P { id: i32, m: Map[i32, i32] } function main(): i32 { var d = P { id: 1, m: Map { 1: 10 } }; var u: i32 = d.m.get_or(1, 0) + d.id; var c = P { id: 2, m: Map { 1: 7 } }; var s: i32 = c.m.get_or(1, 0) + c.id + u; if (s != 20) { return 99; } return __rc_underflow_count(); }`, 0, "call __fn___fern_alloc_reuse"},
	...
	{"self-overwrite-tuple-carried-detector", `struct P { id: i32, pr: (i32, i32) } function main(): i32 { var d = P { id: 1, pr: (10, 20) }; var c = P { ...d, id: 2 }; var s: i32 = c.pr.0 + c.pr.1 + c.id; if (s != 32) { return 99; } return __rc_underflow_count(); }`, 0, "call __fn___fern_alloc_reuse"},
	{"self-overwrite-tuple-override-detector", `struct P { id: i32, pr: (i32, i32) } function main(): i32 { var d = P { id: 1, pr: (10, 20) }; var c = P { ...d, pr: (7, 8) }; var s: i32 = c.pr.0 + c.pr.1 + c.id; if (s != 16) { return 99; } return __rc_underflow_count(); }`, 0, "call __fn___fern_alloc_reuse"},
	{"cross-struct-tuple-field-detector", `struct P { id: i32, pr: (i32, i32) } function main(): i32 { var d = P { id: 1, pr: (10, 20) }; var u: i32 = d.pr.0 + d.id; var c = P { id: 2, pr: (7, 8) }; var s: i32 = c.pr.0 + c.pr.1 + c.id + u; if (s != 28) { return 99; } return __rc_underflow_count(); }`, 0, "call __fn___fern_alloc_reuse"},
	{"self-overwrite-option-carried-detector", `struct Q { id: i32, o: Option[i32] } function main(): i32 { var d = Q { id: 1, o: Some(10) }; var c = Q { ...d, id: 2 }; var r: i32 = 0; match (c.o) { Some(v) => { r = v + c.id; }, None => { r = 0; } } if (r != 12) { return 99; } return __rc_underflow_count(); }`, 0, "call __fn___fern_alloc_reuse"},
	{"self-overwrite-option-override-detector", `struct Q { id: i32, o: Option[i32] } function main(): i32 { var d = Q { id: 1, o: Some(10) }; var c = Q { ...d, o: Some(30) }; var r: i32 = 0; match (c.o) { Some(v) => { r = v + c.id; }, None => { r = 0; } } if (r != 31) { return 99; } return __rc_underflow_count(); }`, 0, "call __fn___fern_alloc_reuse"},
	...
	{"enum-donor-detector", `enum E { A(i32, i32), B(i32, i32) } struct W { p: i32, q: i32 } function main(): i32 { var one: i32 = 1; var x = A(10, 20); var t = 0; match (x) { A(a, b) => { t = a + b; }, B(c, d) => { t = c - d; }, } var y = W { p: 3 * one, q: 4 }; var s = t + y.p + y.q; if (s != 37) { return 99; } return __rc_underflow_count(); }`, 0, "call __fn___fern_alloc_reuse"},
	...
	{"enum-donor-tuple-field-recipient-detector", `enum D2 { P(i32, i32), Q } struct T { tag: i32, t: (i32, i32) } function main(): i32 { var x: D2 = P(3, 4); var u: i32 = 0; match (x) { P(a, b) => { u = a + b; }, Q => { u = 0; } } var y = T { tag: 2, t: (7, 8) }; var s: i32 = y.tag + y.t.0 + y.t.1 + u; if (s != 24) { return 99; } return __rc_underflow_count(); }`, 0, "call __fn___fern_alloc_reuse"},
	...
	{"enum-cross-detector", `enum E { A(i32[]), B(i32[]) } function f(): i32 { var a: E = A([1, 2]); var t: i32 = 0; match (a) { A(_) => { t = 5; }, B(_) => { t = 6; } } var c: E = B([3, 4]); var v: i32 = 0; match (c) { A(w) => { v = w[0]; }, B(w) => { v = w[0] + w[1]; } } if (t + v != 12) { return 99; } return __rc_underflow_count(); } function main(): i32 { return f(); }`, 0, "call __fn___fern_alloc_reuse"},
	...
	{"inarm-array-replace-detector", `enum E { V(i32, i32[]), W(i32, i32[]) } function go(): i32 { var x = V(3, [10, 20, 30]); var y = match (x) { V(a, xs) => W(a, [7, 8]), W(b, ys) => V(b, ys) }; var r = 0; match (y) { V(a, xs) => { r = a + xs[0] + xs[1]; }, W(c, ds) => { r = c + ds[0] + ds[1]; } } if (r != 18) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0, "call __fn___fern_alloc_reuse"},
	...
	{"strarr-field-cross", `struct P { tags: string[], n: i32 } function main(): i32 { var a: P = P { tags: ["x", "y"], n: 1 }; var s1: i32 = a.tags.len() + a.n; var b: P = P { tags: ["z"], n: 2 }; if (__rc_underflow_count() != 0) { return 99; } return s1 + b.tags.len() + b.n; }`, 6, "call __fn___fern_alloc_reuse"},
	{"strarr-field-self-overwrite", `struct P { tags: string[], n: i32 } function main(): i32 { var d: P = P { tags: ["x", "y"], n: 1 }; var c: P = P { ...d, tags: ["z", "w", "v"] }; if (__rc_underflow_count() != 0) { return 99; } return c.tags.len() + c.n; }`, 4, "call __fn___fern_alloc_reuse"},
	{"strarr-field-carried-copy", `struct P { tags: string[], n: i32 } function main(): i32 { var d: P = P { tags: ["x", "y"], n: 1 }; var c: P = P { ...d, n: 5 }; if (__rc_underflow_count() != 0) { return 99; } return c.tags.len() + c.n + c.tags[0].len() + c.tags[1].len(); }`, 9, "call __fn___fern_alloc_reuse"},
	{"strarr-field-churn-detector", `struct P { tags: string[], n: i32 } function churn(n: i32): i32 { var bad: i32 = 0; var i: i32 = 0; while (i < n) { var d: P = P { tags: ["x", "y"], n: i }; var c: P = P { ...d, tags: ["z"] }; if (c.tags.len() + c.n != 1 + i) { bad = 1; } i = i + 1; } return bad; } function main(): i32 { var v: i32 = churn(2000000); if (v != 0) { return 90; } return __rc_underflow_count(); }`, 0, "call __fn___fern_alloc_reuse"},
	...
	{"fn-field-cross", `struct H { f: (i32) => i32, id: i32 } function main(): i32 { var a: H = H { f: (x: i32): i32 => { return x + 3; }, id: 1 }; var s1: i32 = a.id + 4; var b: H = H { f: (x: i32): i32 => { return x * 2; }, id: 2 }; return s1 + b.f(5) + b.id; }`, 17, "call __fn___fern_alloc_reuse"},
	{"fn-field-self-overwrite", `struct H { f: (i32) => i32, id: i32 } function main(): i32 { var d: H = H { f: (x: i32): i32 => { return x + 3; }, id: 1 }; var c: H = H { ...d, f: (x: i32): i32 => { return x * 4; } }; if (__rc_underflow_count() != 0) { return 99; } return c.f(5) + c.id; }`, 21, "call __fn___fern_alloc_reuse"},
	{"fn-field-carried-copy", `struct H { f: (i32) => i32, id: i32 } function main(): i32 { var d: H = H { f: (x: i32): i32 => { return x + 3; }, id: 1 }; var c: H = H { ...d, id: 7 }; if (__rc_underflow_count() != 0) { return 99; } return c.f(5) + c.id; }`, 15, "call __fn___fern_alloc_reuse"},
	{"fn-field-churn-detector", `struct H { f: (i32) => i32, id: i32 } function churn(n: i32): i32 { var bad: i32 = 0; var i: i32 = 0; while (i < n) { var d: H = H { f: (x: i32): i32 => { return x + 1; }, id: i }; var c: H = H { ...d, f: (x: i32): i32 => { return x + 2; } }; if (c.f(10) + c.id != 12 + i) { bad = 1; } i = i + 1; } return bad; } function main(): i32 { var v: i32 = churn(2000000); if (v != 0) { return 90; } return __rc_underflow_count(); }`, 0, "call __fn___fern_alloc_reuse"},
	{"enum-donor-fn-field-recipient", `enum D2 { P(i32, i32), Q } struct M { tag: i32, g: (i32) => i32 } function main(): i32 { var x: D2 = P(3, 4); var u: i32 = 0; match (x) { P(a, b) => { u = a + b; }, Q => { u = 0; } } var y = M { tag: 2, g: (q: i32): i32 => { return q + 1; } }; return y.g(1) + y.tag + u; }`, 11, "call __fn___fern_alloc_reuse"},
	...
	{"boxarr-struct-cross", `struct In { k: i32, n: i32 } struct W { items: In[], id: i32 } function main(): i32 { var a: W = W { items: [In { k: 1, n: 2 }, In { k: 3, n: 4 }], id: 1 }; var s1: i32 = a.items.len() + a.items[1].k + a.id; var b: W = W { items: [In { k: 5, n: 6 }], id: 2 }; if (__rc_underflow_count() != 0) { return 99; } return s1 + b.items.len() + b.items[0].n + b.id; }`, 15, "call __fn___fern_alloc_reuse"},
	{"boxarr-struct-churn-detector", `struct In { k: i32, n: i32 } struct W { items: In[], id: i32 } function churn(n: i32): i32 { var bad: i32 = 0; var i: i32 = 0; while (i < n) { var a: W = W { items: [In { k: i, n: 2 }, In { k: 3, n: 4 }], id: i }; var t: i32 = a.items.len() + a.items[0].k + a.id; var b: W = W { items: [In { k: 5, n: i }], id: i + 1 }; if (t != 2 + i + i) { bad = 1; } if (b.items.len() + b.items[0].n + b.id != 2 + i + i) { bad = 1; } i = i + 1; } return bad; } function main(): i32 { var v: i32 = churn(1000000); if (v != 0) { return 90; } return __rc_underflow_count(); }`, 0, "call __fn___fern_alloc_reuse"},
	{"boxarr-enum-cross", `enum St { On(i32), Off } struct W { sts: St[], id: i32 } function main(): i32 { var a: W = W { sts: [On(3), Off], id: 1 }; var s1: i32 = a.sts.len() + a.id; var b: W = W { sts: [On(7)], id: 2 }; var s2: i32 = b.sts.len() + b.id; match (b.sts[0]) { On(v) => { s2 = s2 + v; }, Off => {} } if (__rc_underflow_count() != 0) { return 99; } return s1 + s2; }`, 13, "call __fn___fern_alloc_reuse"},
	{"boxarr-self-overwrite", `struct In { k: i32, n: i32 } struct W { items: In[], id: i32 } function main(): i32 { var d: W = W { items: [In { k: 1, n: 2 }], id: 6 }; var c: W = W { ...d, items: [In { k: 7, n: 8 }, In { k: 9, n: 10 }] }; if (__rc_underflow_count() != 0) { return 99; } return c.items.len() + c.items[1].k + c.id; }`, 17, "call __fn___fern_alloc_reuse"},
	{"boxarr-carried-copy", `struct In { k: i32, n: i32 } struct W { items: In[], id: i32 } function main(): i32 { var d: W = W { items: [In { k: 1, n: 2 }, In { k: 3, n: 4 }], id: 6 }; var c: W = W { ...d, id: 9 }; if (__rc_underflow_count() != 0) { return 99; } return c.items.len() + c.items[0].k + c.items[1].n + c.id; }`, 16, "call __fn___fern_alloc_reuse"},
	...
	{"mixed-fn-strarr-str-cross", `struct W { f: (i32) => i32, tags: string[], name: string, id: i32 } function main(): i32 { var a: W = W { f: (x: i32): i32 => { return x + 1; }, tags: ["p", "q"], name: "aa", id: 1 }; var s1: i32 = a.id + a.tags.len() + a.name.len(); var b: W = W { f: (x: i32): i32 => { return x * 2; }, tags: ["r"], name: "bbb", id: 2 }; if (__rc_underflow_count() != 0) { return 99; } return s1 + b.f(4) + b.tags.len() + b.name.len() + b.id; }`, 19, "call __fn___fern_alloc_reuse"},
	{"mixed-selfoverwrite-churn-detector", `struct W { f: (i32) => i32, tags: string[], name: string, id: i32 } function churn(n: i32): i32 { var bad: i32 = 0; var i: i32 = 0; while (i < n) { var d: W = W { f: (x: i32): i32 => { return x + 1; }, tags: ["p", "q"], name: "aa", id: i }; var c: W = W { ...d, f: (x: i32): i32 => { return x + 2; }, tags: ["z"] }; if (c.f(10) + c.tags.len() + c.name.len() + c.id != 15 + i) { bad = 1; } i = i + 1; } return bad; } function main(): i32 { var v: i32 = churn(1000000); if (v != 0) { return 90; } return __rc_underflow_count(); }`, 0, "call __fn___fern_alloc_reuse"},
	{"mixed-enum-fn-cross", `enum St { On(i32), Off } struct W { f: (i32) => i32, st: St, id: i32 } function main(): i32 { var a: W = W { f: (x: i32): i32 => { return x + 1; }, st: On(7), id: 1 }; var s1: i32 = a.id; match (a.st) { On(v) => { s1 = s1 + v; }, Off => {} } var b: W = W { f: (x: i32): i32 => { return x * 2; }, st: Off, id: 2 }; var s2: i32 = b.f(4) + b.id; match (b.st) { On(v) => { s2 = s2 + v; }, Off => { s2 = s2 + 100; } } if (__rc_underflow_count() != 0) { return 99; } return s1 + s2; }`, 118, "call __fn___fern_alloc_reuse"},
	...
	{"enumre-inplace-churn", `enum Bag { Keep(i32[]), Swap(i32[]) } function churn(n: i32): i32 { var b: Bag = Keep([0, 0, 0, 0]); var i = 0; while (i < n) { b = Keep([i, i, i, i]); b = Swap([i, i, i, i]); i = i + 1; } var r = 0; match (b) { Keep(_) => { r = 1; }, Swap(_) => { r = 2; }, } if (r != 2) { return 99; } return __rc_underflow_count(); } function main(): i32 { return churn(5); }`, 0, ""},
}
