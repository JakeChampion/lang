...
func TestSelfHostAsmRunX86_64(t *testing.T) {
	...
	cases := []struct {
		...
		},
		{
			...
			"function main(): i32 { var i = 0; while (i < 4) { print(\"tick\"); i = i + 1; } return 0; }",
			0,
			"tick\ntick\ntick\ntick\n",
			"",
		},
		...
		},
		{
			...
			"function main(): i32 { var i = 1; while (i <= 5) { print_int(i); write(\" \"); i = i + 1; } write(\"\\n\"); return 0; }",
			0,
			"1 2 3 4 5 \n",
			"",
		},
		...
		},
		{
			...
			"function main(): i32 { var n = read_int(); print_int(n * 2); write(\"\\n\"); return 0; }",
			0,
			"50\n",
			"25",
		},
		{
			"read-int-square",
			"function main(): i32 { var n = read_int(); print_int(n * n); write(\"\\n\"); return 0; }",
			0,
			"49\n",
			"7",
		},
		{
			"read-int-negative",
			"function main(): i32 { var n = read_int(); if (n < 0) { print(\"neg\"); } else { print(\"pos\"); } return 0; }",
			0,
			"neg\n",
			"-42",
		},
		...
		{
			"squares-1-to-5",
			"function main(): i32 { var i = 1; while (i <= 5) { print_int(i * i); write(\" \"); i = i + 1; } write(\"\\n\"); return 0; }",
			0,
			"1 4 9 16 25 \n",
			"",
		},
		{
			...
			"function pow2(n: i32): i32 { if (n == 0) { return 1; } return 2 * pow2(n - 1); } " +
				"function main(): i32 { var i = 0; while (i <= 10) { print_int(pow2(i)); write(\" \"); i = i + 1; } write(\"\\n\"); return 0; }",
			0,
		...
		{
			"lambda-no-capture",
			"function main(): i32 { var f = (x: i32): i32 => { return x + 1; }; return f(41); }",
			42,
			"",
			"",
		},
		{
			"lambda-no-args",
			"function main(): i32 { var f = (): i32 => { return 7; }; return f(); }",
			7,
			"",
			"",
		},
		{
			"lambda-multi-args",
			"function main(): i32 { var add = (a: i32, b: i32): i32 => { return a + b; }; return add(20, 22); }",
			42,
			"",
			"",
		},
		{
			"lambda-with-locals",
			"function main(): i32 { var f = (n: i32): i32 => { var sq = n * n; var dbl = n + n; return sq + dbl; }; return f(5); }",
			35,
			"",
			"",
		},
		{
			...
			"function main(): i32 { var n = 5; var f = (x: i32): i32 => { return x + n; }; return f(7); }",
			12,
			"",
			"",
		},
		{
			...
			"function main(): i32 { var a = 10; var b = 20; var f = (): i32 => { return a + b; }; return f(); }",
			30,
			"",
			"",
		},
		{
			...
			"function main(): i32 { var n = 5; var f = (): i32 => { return n; }; n = 99; return f(); }",
			99,
			"",
			"",
		},
		{
			...
			"function main(): i32 { var k = 100; var g = (x: i32, y: i32): i32 => { return x + y + k; }; return g(2, 3); }",
			105,
			"",
			"",
		},
		{
			...
			"function main(): i32 { var n = 7; var outer = (): i32 => { var inner = (): i32 => { return n; }; return inner(); }; return outer(); }",
			7,
			"",
			"",
		},
		...
		},
		{
			...
			"function main(): i32 { var s = \"hi\"; var f = (): string => { return s; }; write(f()); return 0; }",
			0,
			"hi",
			"",
		},
		{
			...
			"function main(): i32 { var prefix = \"hello-\"; var f = (suf: string): string => { return prefix + suf; }; write(f(\"world\")); return 0; }",
			0,
			"hello-world",
			"",
		},
		{
			...
			"function main(): i32 { var x = 5; var is_big = (): boolean => { return x > 3; }; if (is_big()) { return 1; } return 0; }",
			1,
			"",
			"",
		},
		{
			...
			"function main(): i32 { var a = \"foo\"; var b = \"bar\"; var f = (): string => { return a + b; }; write(f()); return 0; }",
			0,
			"foobar",
			"",
		},
		{
			...
			"function main(): i32 { var s = \"hello\"; var f = (): i32 => { return s.len(); }; return f(); }",
			5,
			"",
			"",
		},
		...
		{
			"arr-i32-min",
			"function main(): i32 { var xs: i32[] = [5, 2, 8, 1, 7]; match (xs.min()) { Some(m) => { return m; }, None => { return 0; } } }",
			1,
			"",
			"",
		},
		{
			"arr-i32-max",
			"function main(): i32 { var xs: i32[] = [5, 2, 8, 1, 7]; match (xs.max()) { Some(m) => { return m; }, None => { return 0; } } }",
			8,
			"",
			"",
		},
		{
			"arr-i32-min-single",
			"function main(): i32 { var xs: i32[] = [42]; match (xs.min()) { Some(m) => { return m; }, None => { return 0; } } }",
			42,
			"",
			"",
		},
		{
			"arr-i32-max-single",
			"function main(): i32 { var xs: i32[] = [42]; match (xs.max()) { Some(m) => { return m; }, None => { return 0; } } }",
			42,
			"",
			"",
		},
		{
			...
			"function main(): i32 { var xs: i32[] = [3, 0 - 5, 1]; match (xs.min()) { Some(m) => { print_int(m); }, None => { } } return 0; }",
			0,
			"-5",
			"",
		},
		{
			...
			"function main(): i32 { var xs: i32[] = [0 - 9, 0 - 2, 0 - 5]; match (xs.max()) { Some(m) => { print_int(m); }, None => { } } return 0; }",
			0,
			"-2",
			"",
		},
		{
			...
			"function main(): i32 { var inner = (): i32 => { return 42; }; var outer = (): i32 => { return inner(); }; return outer(); }",
			42,
			"",
			"",
		},
		{
			...
			"function main(): i32 { var hello = (): string => { return \"hi\"; }; var wrap = (): string => { return hello() + \"!\"; }; write(wrap()); return 0; }",
			0,
			"hi!",
			"",
		},
		{
			...
			"function main(): i32 { var k = 100; var a = (): i32 => { var b = (): i32 => { var c = (): i32 => { return k; }; return c(); }; return b(); }; return a(); }",
			100,
			"",
			"",
		},
		...
		{"str-index-local", "function main(): i32 { var s = \"hello\"; return s[0] as i32; }", 104, "", ""},
		{"str-index-sum", "function main(): i32 { var s = \"hello\"; return (s[1] as i32) + (s[4] as i32); }", 212, "", ""},
		{"str-index-loop", "function main(): i32 { var s = \"abc\"; var sum = 0; var i = 0; while (i < 3) { sum = sum + (s[i] as i32); i = i + 1; } return sum % 200; }", 94, "", ""},
		...
		{"str-slice-len", "function main(): i32 { var s = \"hello\"; var t = slice_unchecked(s, 1, 4); return t.len(); }", 3, "", ""},
		{"str-slice-idx0", "function main(): i32 { var s = \"hello\"; var t = slice_unchecked(s, 1, 4); return t[0] as i32; }", 101, "", ""},
		...
		{"opt-bind-local", "function g(n: i32): Option[i32] { if (n > 0) { return Some(n + 100); } return None; } function f(n: i32): i32 { var r = g(n); match (r) { Some(x) => { return x; }, None => { return 0; } } return 0; } function main(): i32 { return f(5); }", 105, "", ""},
		{"opt-bind-local-strerr", "function chk(n: i32): Result[i32, string] { if (n > 0) { return Ok(n); } return Err(\"oops\"); } function f(n: i32): i32 { var r = chk(n); match (r) { Ok(x) => { return x; }, Err(e) => { return e.len(); } } return 0; } function main(): i32 { return f(7) * 10 + f(0); }", 74, "", ""},
		...
		{"struct-field-nested", "struct Point { x: i32, y: i32 } struct Box { p: Point } function bx(b: Box): i32 { return b.p.x + b.p.y; } function main(): i32 { var b = Box { p: Point { x: 30, y: 12 } }; return bx(b); }", 42, "", ""},
		{"struct-field-deep", "struct Inner { v: i32 } struct Mid { inner: Inner, n: i32 } struct Outer { mid: Mid } function f(o: Outer): i32 { return o.mid.inner.v + o.mid.n; } function main(): i32 { var o = Outer { mid: Mid { inner: Inner { v: 100 }, n: 5 } }; return f(o); }", 105, "", ""},
		{"struct-field-bind", "struct Point { x: i32, y: i32 } struct Box { p: Point, tag: i32 } function main(): i32 { var b = Box { p: Point { x: 7, y: 8 }, tag: 3 }; var pp = b.p; return pp.x * pp.y + b.tag; }", 59, "", ""},
		{"forin-i32", "function main(): i32 { var xs = [10, 20, 30, 40]; var sum = 0; for x in xs { sum = sum + x; } return sum; }", 100, "", ""},
		{"forin-i32-param", "function total(xs: i32[]): i32 { var s = 0; for v in xs { s = s + v; } return s; } function main(): i32 { var a = [1, 2, 3, 4, 5]; return total(a); }", 15, "", ""},
		{"forin-nested", "function main(): i32 { var xs = [1, 2, 3]; var t = 0; for a in xs { for b in xs { t = t + a * b; } } return t; }", 36, "", ""},
		{"forin-string", "function main(): i32 { var ss: string[] = [\"a\", \"bb\", \"ccc\", \"dddd\"]; var n = 0; for s in ss { n = n + s.len(); } return n; }", 10, "", ""},
		...
		{"tuple-3-destructure", "function main(): i32 { var (a, b, c) = (1, 2, 3); return a * 100 + b * 10 + c; }", 123, "", ""},
		{"tuple-4-destructure", "function main(): i32 { var (a, b, c, d) = (1, 2, 3, 4); return a + b + c + d; }", 10, "", ""},
		{"tuple-3-mixed-destructure", "function main(): i32 { var (s, n, m) = (\"hi\", 5, 10); return s.len() + n + m; }", 17, "", ""},
		{"tuple-3-local-destructure", "function main(): i32 { var t = (7, 8, 9); var (a, b, c) = t; return a + b * c; }", 79, "", ""},
		...
		{"strcmp-lt", "function main(): i32 { var a = \"apple\"; var b = \"banana\"; if (a < b) { return 7; } return 0; }", 7, "", ""},
		{"strcmp-gt", "function main(): i32 { var a = \"banana\"; var b = \"apple\"; if (a > b) { return 3; } return 0; }", 3, "", ""},
		...
		{"method-7-args", "struct P { base: i32 } function (p: P) sum7(a:i32,b:i32,c:i32,d:i32,e:i32,f:i32,g:i32): i32 { return p.base + a+b+c+d+e+f+g; } function main(): i32 { var p = P { base: 10 }; return p.sum7(1,2,3,4,5,6,7); }", 38, "", ""},
		{"i64-param", "function dbl(x: i64): i64 { return x * 2; } function main(): i32 { var r: i64 = dbl(3000000000); if (r > 5000000000) { return 7; } return 0; }", 7, "", ""},
		{"i64-return", "function big(): i64 { return 4000000000; } function main(): i32 { var x: i64 = big() + 1000000000; if (x > 4000000000) { return 5; } return 0; }", 5, "", ""},
		{"i64-param-mixed", "function f(a: i64, b: i32): i64 { return a + (b as i64); } function main(): i32 { var r: i64 = f(4000000000, 5); if (r > 4000000000) { return 9; } return 0; }", 9, "", ""},
		...
		{"i64-div", "function main(): i32 { var a: i64 = 12000000000; var b: i64 = 4; var c: i64 = a / b; if (c > 2000000000) { return 7; } return 0; }", 7, "", ""},
