...
function fixture(): ssasem.Func {
    ...
    return ssasem.Func { envs: [], anchors: [], dyns: [], graph: graph, values: types, params: params, result: row, records: [], enums: [], calls: [] };
}
function main(): i32 {
    var f = fixture();
    var modes: i32[] = MODES;
...
function binary_masks(op: string, t: typeinfo.Type, result: typeinfo.Type): string {
    ...
    var f = ssasem.Func { envs: [], anchors: [], dyns: [], graph: g, values: [t, t, result], params: [t, t], result: result,
        records: [], enums: [], calls: [] };
...
function wide_binary(t: typeinfo.Type, result: typeinfo.Type, op: string): ssasem.Func {
    var g = ssa.SFunc { name: "wbin", nparams: 2, nvals: 3, entry: 7, takes_env: false,
        blocks: [ssa.SBlock { id: 7, preds: [], insts: [inst(6, 0, [], 0), inst(6, 1, [], 1),
            ssa.SInst { kind_tag: 9, result: 2, args: [0, 1], imm: 0, str: op }], term: ret(2) }] };
    return ssasem.Func { envs: [], anchors: [], dyns: [], graph: g, values: [t, t, result], params: [t, t], result: result,
        records: [], enums: [], calls: [] };
}
function cast_masks(from: typeinfo.Type, to: typeinfo.Type): string {
    ...
    var f = ssasem.Func { envs: [], anchors: [], dyns: [], graph: g, values: [from, to], params: [from], result: to,
        records: [], enums: [], calls: [] };
...
function main(): i32 {
    ...
    var typed = ssasem.Func { envs: [], anchors: [], dyns: [], graph: g, values: [wide], params: [wide], result: wide, records: [], enums: [], calls: [] };
    ...
    var genericFunc = ssasem.Func { envs: [], anchors: [], dyns: [], graph: recordGraph, values: [f.result, wideType], params: [f.result], result: wideType, records: [wideSchema], enums: [], calls: [] };
    ...
    var wideFieldFunc = ssasem.Func { envs: [], anchors: [], dyns: [], graph: g, values: [recordType], params: [recordType], result: recordType, records: [wideField], enums: [], calls: [] };
    ...
    var recordFunc = ssasem.Func { envs: [], anchors: [], dyns: [], graph: recordGraph, values: [f.result, recordType], params: [f.result], result: recordType, records: [schema], enums: [], calls: [] };
    ...
    var wideEnumFunc = ssasem.Func { envs: [], anchors: [], dyns: [], graph: enumGraph, values: [f.result, shapeType], params: [f.result], result: shapeType, records: [wideSchema], enums: [wideEnum], calls: [] };
    ...
    var enumFunc = ssasem.Func { envs: [], anchors: [], dyns: [], graph: enumGraph, values: [f.result, shapeType], params: [f.result], result: shapeType, records: [], enums: [arrayEnum], calls: [] };
    ...
    var selfGraph = ssa.SFunc { name: "cycle", nparams: 1, nvals: 1, entry: 7, takes_env: false,
        blocks: [ssa.SBlock { id: 7, preds: [], insts: [inst(6, 0, [], 0)], term: ret(0) }] };
    var selfFunc = ssasem.Func { envs: [], anchors: [], dyns: [], graph: selfGraph, values: [selfType], params: [selfType], result: selfType, records: [selfSchema], enums: [], calls: [] };
    ...
    var flatFunc = ssasem.Func { envs: [], anchors: [], dyns: [], graph: selfGraph, values: [flatType], params: [flatType], result: flatType, records: [flatSchema], enums: [], calls: [] };
    ...
    var boxOnlyFunc = ssasem.Func { envs: [], anchors: [], dyns: [], graph: selfGraph, values: [boxOnly], params: [boxOnly], result: boxOnly, records: [boxOnlySchema], enums: [], calls: [] };
    ...
    var withKidsFunc = ssasem.Func { envs: [], anchors: [], dyns: [], graph: selfGraph, values: [withKids], params: [withKids], result: withKids, records: [withKidsSchema], enums: [], calls: [] };
    ...
    var arrLen = ssasem.Func { envs: [], anchors: [], dyns: [], graph: lenGraph, values: [f.result, i32ty], params: [f.result], result: i32ty, records: [], enums: [], calls: [] };
    ...
    var strLen = ssasem.Func { envs: [], anchors: [], dyns: [], graph: lenGraph, values: [strTy, i32ty], params: [strTy], result: i32ty, records: [], enums: [], calls: [] };
    ...
    var badRecv = ssasem.Func { envs: [], anchors: [], dyns: [], graph: lenGraph, values: [boxOnly, i32ty], params: [boxOnly], result: i32ty, records: [boxOnlySchema], enums: [], calls: [] };
    if (ssaunits.plan(badRecv, [2]).why != "length container type") { return 38; }
    var badResult = ssasem.Func { envs: [], anchors: [], dyns: [], graph: lenGraph, values: [f.result, f.result], params: [f.result], result: f.result, records: [], enums: [], calls: [] };
    ...
    var appendFunc = ssasem.Func { envs: [], anchors: [], dyns: [], graph: appendGraph, values: [f.result, i32ty, f.result],
    ...
    var growFunc = ssasem.Func { envs: [], anchors: [], dyns: [], graph: growGraph, values: [growType, i32ty, f.result, f.result, i32ty, growType],
    ...
    var callFunc = ssasem.Func { envs: [], anchors: [], dyns: [], graph: callGraph, values: [growType, i32ty, growType, i32ty],
    ...
    var viaGraph = ssa.SFunc { name: "via", nparams: 2, nvals: 6, entry: 7, takes_env: false,
        blocks: [ssa.SBlock { id: 7, preds: [], insts: [inst(6, 0, [], 0), inst(6, 1, [], 1),
            ...
            ssa.SInst { kind_tag: ssasem.record_get(), result: 4, args: [0], imm: 1, str: "n" },
            inst(ssasem.record_new(), 5, [3, 4], 0)], term: ret(5) }] };
    var viaFunc = ssasem.Func { envs: [], anchors: [], dyns: [], graph: viaGraph, values: [growType, i32ty, f.result, f.result, i32ty, growType],
    ...
    var withFunc = ssasem.Func { envs: [], anchors: [], dyns: [], graph: withGraph, values: [f.result, i32ty, i32ty, f.result],
    ...
    var badRecvAppend = ssasem.Func { envs: [], anchors: [], dyns: [], graph: appendGraph, values: [strTy, i32ty, strTy],
    ...
    var sliceFunc = ssasem.Func { envs: [], anchors: [], dyns: [], graph: sliceGraph, values: [strTy, i32ty, i32ty, viewTy],
    ...
    var plainGraph = ssa.SFunc { name: "plain", nparams: 1, nvals: 1, entry: 7, takes_env: false,
        blocks: [ssa.SBlock { id: 7, preds: [], insts: [inst(6, 0, [], 0)], term: ret(0) }] };
    var plainFunc = ssasem.Func { envs: [], anchors: [], dyns: [], graph: plainGraph, values: [strTy], params: [strTy], result: strTy,
        records: [], enums: [], calls: [] };
    ...
    var wideFunc = ssasem.Func { envs: [], anchors: [], dyns: [], graph: dropGraph, values: [wideRec, i32ty], params: [wideRec], result: i32ty,
    ...
    var wideVal = ssasem.Func { envs: [], anchors: [], dyns: [], graph: dropGraph, values: [f64ty, i32ty], params: [f64ty], result: i32ty,
        records: [], enums: [], calls: [] };
    ...
    var floatElem = ssasem.Func { envs: [], anchors: [], dyns: [], graph: ssa.SFunc { ...dropGraph, nvals: 2, blocks: [ssa.SBlock { id: 7, preds: [], insts: [inst(6, 0, [], 0),
    ...
    var floatK = ssasem.Func { envs: [], anchors: [], dyns: [], graph: ssa.SFunc { ...dropGraph, nparams: 0, nvals: 1,
    ...
    var idxFunc = ssasem.Func { envs: [], anchors: [], dyns: [], graph: idxGraph, values: [strTy, i32ty, u8ty],
    ...
    var negFunc = ssasem.Func { envs: [], anchors: [], dyns: [], graph: negGraph, values: [i32ty, i32ty], params: [i32ty], result: i32ty,
        records: [], enums: [], calls: [] };
    ...
    var kFunc = ssasem.Func { envs: [], anchors: [], dyns: [], graph: kGraph, values: [u8ty], params: [], result: u8ty,
        records: [], enums: [], calls: [] };
    ...
    var wideArrFunc = ssasem.Func { envs: [], anchors: [], dyns: [], graph: g, values: [wideArr], params: [wideArr], result: wideArr,
        records: [], enums: [], calls: [] };
    ...
    var wideElem = ssasem.Func { envs: [], anchors: [], dyns: [], graph: ssa.SFunc { ...dropGraph, nvals: 2, blocks: [ssa.SBlock { id: 7, preds: [],
    ...
    var buildFunc = ssasem.Func { envs: [], anchors: [], dyns: [], graph: buildGraph, values: [i64ty, wideTup], params: [i64ty], result: wideTup,
        records: [], enums: [], calls: [] };
    ...
    var sneakFunc = ssasem.Func { envs: [], anchors: [], dyns: [], graph: buildGraph, values: [i64ty, narrowTup], params: [i64ty], result: narrowTup,
        records: [], enums: [], calls: [] };
    ...
    var wide64Func = ssasem.Func { envs: [], anchors: [], dyns: [], graph: wide64Graph, values: [i64ty, wide64Ty], params: [i64ty], result: wide64Ty,
    ...
    var spanFunc = ssasem.Func { envs: [], anchors: [], dyns: [], graph: spanGraph, values: [i64ty, spanTy], params: [i64ty], result: spanTy,
    ...
    var wideKFunc = ssasem.Func { envs: [], anchors: [], dyns: [], graph: wideK, values: [i64ty], params: [], result: i64ty,
        records: [], enums: [], calls: [] };
    ...
    var narrowText = ssasem.Func { envs: [], anchors: [], dyns: [], graph: wideK, values: [i32ty], params: [], result: i32ty,
        records: [], enums: [], calls: [] };
    ...
    var mapFunc = ssasem.Func { envs: [], anchors: [], dyns: [], graph: g, values: [mapTy], params: [mapTy], result: mapTy,
        records: [], enums: [], calls: [] };
    ...
    var dropIntMap = ssasem.Func { envs: [], anchors: [], dyns: [], graph: dropMapGraph, values: [intMapTy, i32ty], params: [intMapTy], result: i32ty, records: [], enums: [], calls: [] };
    ...
    var arrInsert = ssasem.Func { envs: [], anchors: [], dyns: [], graph: arrInsertGraph, values: [arrMapTy, strTy, typeinfo.TypeArray { elem: i32ty, view: false }, arrMapTy], params: [arrMapTy, strTy, typeinfo.TypeArray { elem: i32ty, view: false }], result: arrMapTy, records: [], enums: [], calls: [] };
    ...
    var intInsertGraph = ssa.SFunc { name: "int_insert", nparams: 3, nvals: 4, entry: 7, takes_env: false,
        blocks: [ssa.SBlock { id: 7, preds: [], insts: [inst(6, 0, [], 0), inst(6, 1, [], 1), inst(6, 2, [], 2),
            ssa.SInst { kind_tag: ssasem.map_insert(), result: 3, args: [0, 1, 2], imm: 0, str: "" }], term: ret(3) }] };
    var intInsert = ssasem.Func { envs: [], anchors: [], dyns: [], graph: intInsertGraph, values: [intMapTy, i32ty, i32ty, intMapTy], params: [intMapTy, i32ty, i32ty], result: intMapTy, records: [], enums: [], calls: [] };
    ...
    var lenMap = ssasem.Func { envs: [], anchors: [], dyns: [], graph: lenMapGraph, values: [intMapTy, i32ty], params: [intMapTy], result: i32ty, records: [], enums: [], calls: [] };
    ...
    var endFunc = ssasem.Func { envs: [], anchors: [], dyns: [], graph: endGraph, values: [strTy], params: [strTy], result: i32ty, records: [], enums: [], calls: [] };
    ...
    var getMap = ssasem.Func { envs: [], anchors: [], dyns: [], graph: getGraph, values: [intMapTy, i32ty, optI32Ty], params: [intMapTy, i32ty], result: optI32Ty, records: [], enums: [optEnum], calls: [] };
