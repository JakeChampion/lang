...
// files of 427 and #6832 had already taken it from 71; the last ten classes went
...
// hand-run 427-file sweep, not by this suite, and every row it produced had to
...
//
// Cheap enough to belong here: 427 `-fmt` invocations of the linked driver take
