...
func TestSelfHostRcPreciseDropX86IR(t *testing.T) {
	...
	cases := []struct {
		...
		{"two-arrays-detector", `function main(): i32 { var a = [10, 20, 30]; var s = 0; var i = 0; while (i < 3) { s = s + a[i]; i = i + 1; } var b = [1, 2, 3, 4]; var t = 0; var k = 0; while (k < 4) { t = t + b[k]; k = k + 1; } if (s + t != 70) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"builder-call-detector", `function build(): i32[] { return [1, 2, 3, 4]; } function main(): i32 { var a = build(); var s = 0; var i = 0; while (i < 4) { s = s + a[i]; i = i + 1; } if (s != 10) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"borrow-helper-detector", `function sum_arr(v: i32[]): i32 { var s = 0; var i = 0; while (i < v.len()) { s = s + v[i]; i = i + 1; } return s; } function main(): i32 { var t = [1, 2, 3, 4]; var a = sum_arr(t); var b = sum_arr(t); if (a + b != 20) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"escape-helper-detector", `function keep(v: i32[]): i32[] { return v; } function main(): i32 { var t = [1, 2, 3, 4]; var u = keep(t); var a = u[0]; if (a != 1) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"transitive-reclaim-detector", `function inner(v: i32[]): i32 { return v[0]; } function outer(v: i32[]): i32 { return inner(v); } function main(): i32 { var t = [5, 6, 7]; var a = outer(t); if (a != 5) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"escape-chain-detector", `function idf(v: i32[]): i32[] { return v; } function wrap(v: i32[]): i32[] { return idf(v); } function main(): i32 { var t = [3, 4, 5]; var u = wrap(t); if (u[1] != 4) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"caller-before-callee-detector", `function outer(v: i32[]): i32 { return inner(v); } function inner(v: i32[]): i32 { return v[0]; } function main(): i32 { var t = [5, 6, 7]; var a = outer(t); if (a != 5) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"i64arr-two-arrays-detector", `function main(): i32 { var v: i64[] = [10, 20, 30]; var s: i64 = 0; var i = 0; while (i < 3) { s = s + v[i]; i = i + 1; } var w: i64[] = [1, 2, 3, 4]; var t: i64 = 0; var k = 0; while (k < 4) { t = t + w[k]; k = k + 1; } if ((s + t) as i32 != 70) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"f64arr-two-arrays-detector", `function main(): i32 { var v: f64[] = [1.5, 2.5, 3.0]; var s: f64 = 0.0; var i = 0; while (i < 3) { s = s + v[i]; i = i + 1; } var w: f64[] = [0.5, 0.5]; var t: f64 = 0.0; var k = 0; while (k < 2) { t = t + w[k]; k = k + 1; } if ((s + t) as i32 != 8) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"i64arr-builder-call-detector", `function build64(): i64[] { return [1, 2, 3, 4]; } function main(): i32 { var a = build64(); var s: i64 = 0; var i = 0; while (i < 4) { s = s + a[i]; i = i + 1; } if (s as i32 != 10) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"f64arr-builder-call-detector", `function buildf(): f64[] { return [1.5, 2.5]; } function main(): i32 { var a = buildf(); var s: f64 = 0.0; var i = 0; while (i < 2) { s = s + a[i]; i = i + 1; } if (s as i32 != 4) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"struct-reuse-detector", `struct Point { x: i32, y: i32 } function main(): i32 { var d = Point { x: 3, y: 4 }; var c = Point { ...d, x: 10 }; var sum = c.x + c.y; if (sum != 14) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"struct-no-reuse-base-used-after-detector", `struct Point { x: i32, y: i32 } function main(): i32 { var d = Point { x: 3, y: 4 }; var c = Point { ...d, x: 10 }; var r = c.x + c.y + d.x; if (r != 17) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"struct-reuse-array-field-keep-detector", `struct Vec { tag: i32, items: i32[] } function main(): i32 { var d = Vec { tag: 1, items: [10, 20, 30] }; var c = Vec { ...d, tag: 2 }; var s = c.items[0] + c.items[1] + c.items[2] + c.tag; if (s != 62) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"struct-reuse-array-field-replace-detector", `struct Vec { tag: i32, items: i32[] } function main(): i32 { var d = Vec { tag: 1, items: [10, 20, 30] }; var c = Vec { ...d, tag: 7, items: [100, 200] }; var s = c.items[0] + c.items[1] + c.tag; if (s != 307) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"struct-reuse-i64-field-detector", `struct Box { a: i64, items: i32[] } function main(): i32 { var d = Box { a: 5, items: [1, 2, 3] }; var c = Box { ...d, a: 40 }; var av: i64 = c.a; var s = (av as i32) + c.items[0] + c.items[1] + c.items[2]; if (s != 46) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"struct-no-reuse-array-base-used-after-detector", `struct Vec { tag: i32, items: i32[] } function main(): i32 { var d = Vec { tag: 1, items: [10, 20, 30] }; var c = Vec { ...d, tag: 9 }; var r = c.tag + d.items[0]; if (r != 19) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"struct-cross-reuse-detector", `struct Point { x: i32, y: i32 } function main(): i32 { var d = Point { x: 3, y: 4 }; var u = d.x + d.y; var c = Point { x: 10, y: 20 }; var sum = c.x + c.y + u; if (sum != 37) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"struct-cross-reuse-array-detector", `struct Vec { tag: i32, items: i32[] } function main(): i32 { var d = Vec { tag: 1, items: [10, 20, 30] }; var u = d.items[0]; var c = Vec { tag: 2, items: [100, 50] }; var s = c.items[0] + c.items[1] + c.tag + u; if (s != 162) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"struct-cross-reuse-callret-donor-detector", `struct Point { x: i32, y: i32 } function mk(a: i32): Point { return Point { x: a, y: a + 1 }; } function main(): i32 { var d: Point = mk(3); var u = d.x + d.y; var c = Point { x: 10, y: 20 }; var sum = c.x + c.y + u; if (sum != 37) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"struct-cross-reuse-callret-array-detector", `struct Vec { tag: i32, items: i32[] } function mkv(t: i32): Vec { return Vec { tag: t, items: [10, 20, 30] }; } function main(): i32 { var d: Vec = mkv(1); var u = d.items[0]; var c = Vec { tag: 2, items: [100, 50] }; var s = c.items[0] + c.items[1] + c.tag + u; if (s != 162) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"struct-cross-no-reuse-nonfresh-callee-detector", `struct Point { x: i32, y: i32 } function pick(p: Point): Point { return p; } function main(): i32 { var s0 = Point { x: 3, y: 4 }; var d: Point = pick(s0); var u = d.x + d.y; var c = Point { x: 10, y: 20 }; var s = c.x + c.y + u; if (s != 37) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"struct-cross-no-reuse-unannotated-callret-detector", `struct Point { x: i32, y: i32 } function mk(a: i32): Point { return Point { x: a, y: a + 1 }; } function main(): i32 { var d = mk(3); var u = d.x + d.y; var c = Point { x: 10, y: 20 }; var s = c.x + c.y + u; if (s != 37) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"struct-cross-reuse-enum-field-detector", `enum St { On(i32), Off } struct M { tag: i32, st: St } function main(): i32 { var d = M { tag: 1, st: On(5) }; var u: i32 = 0; match (d.st) { On(v) => { u = v + d.tag; }, Off => { u = d.tag; } } var c = M { tag: 2, st: On(10) }; var r: i32 = 0; match (c.st) { On(v) => { r = v + c.tag + u; }, Off => { r = 0; } } if (r != 18) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"struct-selfoverwrite-enum-override-detector", `enum St { On(i32), Off } struct M { tag: i32, st: St } function main(): i32 { var d = M { tag: 1, st: On(5) }; var c = M { ...d, st: On(9) }; var r: i32 = 0; match (c.st) { On(v) => { r = v + c.tag; }, Off => { r = 0; } } if (r != 10) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"struct-selfoverwrite-enum-carried-detector", `enum St { On(i32), Off } struct M { tag: i32, st: St } function main(): i32 { var d = M { tag: 1, st: On(5) }; var c = M { ...d, tag: 2 }; var r: i32 = 0; match (c.st) { On(v) => { r = v + c.tag; }, Off => { r = 0; } } if (r != 7) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"struct-string-field-reuse-detector", `struct N { id: i32, name: string } function main(): i32 { var d = N { id: 1, name: "ab" + "c" }; var u: i32 = d.name.len() as i32 + d.id; var c = N { id: 2, name: "wxyz" + "q" }; var s: i32 = c.name.len() as i32 + c.id + u; if (s != 11) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"struct-string-field-corruption-detector", `struct N { id: i32, name: string } function main(): i32 { var d = N { id: 1, name: "ab" + "c" }; var u: i32 = d.name.len() as i32; var c = N { id: 2, name: "wxyz" + "q" }; var fresh = [11, 22, 33]; var s = fresh[0] + fresh[1] + fresh[2]; if (u != 3) { return 90; } if (s != 66) { return 91; } if (c.name[0] != 119) { return 92; } return __rc_underflow_count(); }`, 0},
		...
		{"struct-cross-type-class-pairing-detector", `struct A { n: i32, xs: i32[] } struct B { ys: i32[], m: i32 } function main(): i32 { var d = A { n: 3, xs: [10, 20] }; var u: i32 = d.n + d.xs[0]; var c = B { ys: [7, 8, 9], m: 2 }; var s: i32 = c.ys[2] + c.m + u; if (s != 24) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"struct-cross-type-corruption-detector", `struct A { n: i32, xs: i32[] } struct B { ys: i32[], m: i32 } function main(): i32 { var d = A { n: 3, xs: [10, 20] }; var u: i32 = d.xs[1]; var c = B { ys: [40, 2], m: 5 }; var fresh = [11, 22, 33]; var s = fresh[0] + fresh[1] + fresh[2]; if (u != 20) { return 90; } if (s != 66) { return 91; } if (c.ys[0] + c.ys[1] + c.m != 47) { return 92; } return __rc_underflow_count(); }`, 0},
		// NON-firing: different field COUNTS = different box class — never paired.
		{"struct-cross-no-reuse-class-mismatch-detector", `struct A { n: i32, xs: i32[] } struct C3 { a: i32, b: i32, cc: i32 } function main(): i32 { var d = A { n: 3, xs: [10, 20] }; var u: i32 = d.n + d.xs[0]; var c = C3 { a: 1, b: 2, cc: 3 }; var s: i32 = c.a + c.b + c.cc + u; if (s != 19) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"struct-cross-no-reuse-donor-used-after-detector", `struct Point { x: i32, y: i32 } function main(): i32 { var d = Point { x: 3, y: 4 }; var c = Point { x: 10, y: 20 }; var r = c.x + c.y + d.x; if (r != 33) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"plain-struct-reclaim-detector", `struct P { x: i32, y: i32 } function compute(): i32 { var d = P { x: 3, y: 4 }; return d.x + d.y; } function main(): i32 { var r = compute(); if (r != 7) { return 99; } return __rc_underflow_count(); }`, 0},
		// Two independent plain structs, both reclaimed at exit — both boxes freed,
		// detector 0.
		{"two-plain-structs-reclaim-detector", `struct P { x: i32, y: i32 } function main(): i32 { var a = P { x: 1, y: 2 }; var b = P { x: 3, y: 4 }; var s = a.x + a.y + b.x + b.y; if (s != 10) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"scalar-struct-precise-if-detector", `struct P { x: i32, y: i32 } function f(n: i32): i32 { var p = P { x: 1, y: 2 }; var c = 0; if (n > 0) { c = p.x + p.y; } return c + n; } function main(): i32 { var r = f(5); if (r != 8) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"scalar-struct-precise-corruption-probe-detector", `struct P { x: i32, y: i32 } function go(): i32 { var p = P { x: 3, y: 4 }; var c = 0; var i = 0; while (i < 1) { c = p.x + p.y; i = i + 1; } var fresh = [11, 22, 33]; var s = fresh[0] + fresh[1] + fresh[2]; if (c != 7) { return 90; } if (s != 66) { return 91; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"struct-arrfield-precise-if-detector", `struct Buf { xs: i32[], n: i32 } function f(m: i32): i32 { var b = Buf { xs: [10, 20, 30], n: 3 }; var c = 0; if (m > 0) { c = b.xs[1] + b.n; } return c + m; } function main(): i32 { var r = f(5); if (r != 28) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"struct-arrfield-reordered-precise-if-detector", `struct Buf { xs: i32[], n: i32 } function f(m: i32): i32 { var b = Buf { n: 3, xs: [10, 20, 30] }; var c = 0; if (m > 0) { c = b.xs[0] + b.n; } return c + m; } function main(): i32 { var r = f(5); if (r != 18) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"struct-arrfield-precise-corruption-probe-detector", `struct Buf { xs: i32[], n: i32 } function go(): i32 { var b = Buf { xs: [1, 2, 3], n: 5 }; var c = 0; var i = 0; while (i < 1) { c = b.xs[0] + b.xs[2] + b.n; i = i + 1; } var fresh = [11, 22, 33]; var s = fresh[0] + fresh[1] + fresh[2]; if (c != 9) { return 90; } if (s != 66) { return 91; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"scalar-struct-precise-cross-reuse-donor-guard-detector", `struct P { x: i32, y: i32 } function main(): i32 { var a = P { x: 1, y: 2 }; var sa = a.x + a.y; var b = P { x: 3, y: 4 }; var sb = b.x + b.y; if (sa + sb != 10) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		// leaking. Value + the
		// over-release detector (`__rc_underflow_count()==0`) pin that the box is freed
		// exactly once.
		{"scalar-tuple-reclaim-value", `function go(): i32 { var t: (i32, i32) = (3, 4); return t.0 + t.1; } function main(): i32 { return go(); }`, 7},
		{"scalar-tuple-reclaim-detector", `function go(): i32 { var t: (i32, i32) = (3, 4); var r = t.0 + t.1; return r; } function main(): i32 { var v = go(); if (v != 7) { return 99; } return __rc_underflow_count(); }`, 0},
		// 3-element scalar tuple, same shallow free.
		{"scalar-tuple-3elem-detector", `function go(): i32 { var t: (i32, i32, i32) = (10, 20, 30); var r = t.0 + t.1 + t.2; return r; } function main(): i32 { var v = go(); if (v != 60) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"scalar-tuple-corruption-probe-detector", `function go(): i32 { var t: (i32, i32) = (3, 4); var s = t.0 + t.1; var fresh = [11, 22, 33]; var f = fresh[0] + fresh[1] + fresh[2]; if (s != 7) { return 90; } if (f != 66) { return 91; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"scalar-tuple-escapes-not-freed-detector", `function mk(): (i32, i32) { var t: (i32, i32) = (5, 6); return t; } function main(): i32 { var t = mk(); var r = t.0 + t.1; if (r != 11) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"scalar-tuple-precise-if-detector", `function f(n: i32): i32 { var t: (i32, i32) = (3, 4); var c = 0; if (n > 0) { c = t.0 + t.1; } return c + n; } function main(): i32 { var r = f(5); if (r != 12) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"scalar-tuple-precise-corruption-probe-detector", `function go(): i32 { var t: (i32, i32) = (3, 4); var c = 0; var i = 0; while (i < 1) { c = t.0 + t.1; i = i + 1; } var fresh = [11, 22, 33]; var s = fresh[0] + fresh[1] + fresh[2]; if (c != 7) { return 90; } if (s != 66) { return 91; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		// enum free) — instead of leaking. Value + `__rc_underflow_count()==0` pin the box
		...
		{"option-reclaim-detector", `function go(): i32 { var o: Option[i32] = Some(7); var r = 0; match (o) { Some(v) => { r = v; }, None => { r = 0; }, } if (r != 7) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		// None box (payloadless, rc-headered) is freed the same way.
		{"option-none-detector", `function go(): i32 { var o: Option[i32] = None; var r = 0; match (o) { Some(v) => { r = v; }, None => { r = 5; }, } if (r != 5) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		// Un-annotated Some(scalar-literal) is admitted via the literal-payload gate.
		{"option-unannotated-literal-detector", `function go(): i32 { var o = Some(9); var r = 0; match (o) { Some(v) => { r = v; }, None => { r = 0; }, } if (r != 9) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		// i64-payload Option: 8-byte payload, same box free.
		{"option-i64-payload-detector", `function go(): i32 { var o: Option[i64] = Some(100); var r: i64 = 0; match (o) { Some(v) => { r = v; }, None => { r = 0; }, } if (r as i32 != 100) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"option-corruption-probe-detector", `function go(): i32 { var o: Option[i32] = Some(7); var r = 0; match (o) { Some(v) => { r = v; }, None => { r = 0; }, } var fresh = [11, 22, 33]; var s = fresh[0] + fresh[1] + fresh[2]; if (r != 7) { return 90; } if (s != 66) { return 91; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"option-used-after-match-detector", `function go(): i32 { var o: Option[i32] = Some(7); var a = 0; match (o) { Some(v) => { a = v; }, None => { a = 0; }, } var b = 0; match (o) { Some(v) => { b = v; }, None => { b = 0; }, } if (a + b != 14) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		// NON-firing (escapes / returned): a returned Option is moved to the caller, so
		// mk must NOT free it. Detector 0.
		{"option-escapes-not-freed-detector", `function mk(): Option[i32] { var o: Option[i32] = Some(7); return o; } function main(): i32 { var o = mk(); var r = 0; match (o) { Some(v) => { r = v; }, None => { r = 0; }, } if (r != 7) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"result-ok-reclaim-detector", `function go(): i32 { var r: Result[i32, i32] = Ok(7); var x = 0; match (r) { Ok(v) => { x = v; }, Err(e) => { x = e; }, } if (x != 7) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		// Err(scalar) box is freed the same way — the Err payload scalar-ness (E) gates it.
		{"result-err-reclaim-detector", `function go(): i32 { var r: Result[i32, i32] = Err(4); var x = 0; match (r) { Ok(v) => { x = v; }, Err(e) => { x = e; }, } if (x != 4) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"result-distinct-types-detector", `function go(): i32 { var r: Result[i32, boolean] = Ok(9); var x = 0; match (r) { Ok(v) => { x = v; }, Err(e) => { x = 1; }, } if (x != 9) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		// i64-payload Result Ok: 8-byte payload, same box free.
		{"result-i64-payload-detector", `function go(): i32 { var r: Result[i64, i32] = Ok(100); var x: i64 = 0; match (r) { Ok(v) => { x = v; }, Err(e) => { x = 0; }, } if (x as i32 != 100) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"result-corruption-probe-detector", `function go(): i32 { var r: Result[i32, i32] = Ok(7); var x = 0; match (r) { Ok(v) => { x = v; }, Err(e) => { x = e; }, } var fresh = [11, 22, 33]; var s = fresh[0] + fresh[1] + fresh[2]; if (x != 7) { return 90; } if (s != 66) { return 91; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		// NON-firing (used after the match): `r` is matched twice, so it is not dead
		// after the first match — must NOT be freed there. Detector 0 (no over-release).
		{"result-used-after-match-detector", `function go(): i32 { var r: Result[i32, i32] = Ok(7); var a = 0; match (r) { Ok(v) => { a = v; }, Err(e) => { a = e; }, } var b = 0; match (r) { Ok(v) => { b = v; }, Err(e) => { b = e; }, } if (a + b != 14) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		// NON-firing (escapes / returned): a returned Result is moved to the caller, so
		// mk must NOT free it. Detector 0.
		{"result-escapes-not-freed-detector", `function mk(): Result[i32, i32] { var r: Result[i32, i32] = Ok(7); return r; } function main(): i32 { var r = mk(); var x = 0; match (r) { Ok(v) => { x = v; }, Err(e) => { x = e; }, } if (x != 7) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		// borrow ends before the post-match free. Value + `__rc_underflow_count()==0` pin
		...
		{"option-arr-payload-detector", `function go(): i32 { var o: Option[i32[]] = Some([10, 20, 30]); var r = 0; match (o) { Some(v) => { r = v[0] + v[2]; }, None => { r = 0; }, } if (r != 40) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		// Un-annotated Some([..]) (Option infers the single type param) is admitted via
		// the fresh scalar-number array-literal payload gate.
		{"option-arr-unannotated-detector", `function go(): i32 { var o = Some([1, 2, 3]); var r = 0; match (o) { Some(v) => { r = v[1]; }, None => { r = 0; }, } if (r != 2) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		// A borrow that reads .len() as well as indexing still fires + stays clean.
		{"option-arr-len-borrow-detector", `function go(): i32 { var o: Option[i32[]] = Some([4, 5, 6, 7]); var r = 0; match (o) { Some(v) => { r = v.len() + v[0]; }, None => { r = 0; }, } if (r != 8) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"option-f64arr-payload-detector", `function go(): i32 { var o: Option[f64[]] = Some([1.5, 2.5]); var r: f64 = 0.0; match (o) { Some(v) => { r = v[0] + v[1]; }, None => { r = 0.0; }, } if ((r as i32) != 4) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"result-ok-arr-payload-detector", `function go(): i32 { var r: Result[i32[], i32] = Ok([5, 6, 7]); var x = 0; match (r) { Ok(v) => { x = v[0] + v[2]; }, Err(e) => { x = e; }, } if (x != 12) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"result-err-arr-payload-detector", `function go(): i32 { var r: Result[i32, i32[]] = Err([3, 4]); var x = 0; match (r) { Ok(v) => { x = v; }, Err(e) => { x = e[0] + e[1]; }, } if (x != 7) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		// Heap-reuse corruption probe: a fresh array allocated AFTER the option's
		...
		{"option-arr-corruption-probe-detector", `function go(): i32 { var o: Option[i32[]] = Some([1, 2, 3]); var r = 0; match (o) { Some(v) => { r = v[0] + v[2]; }, None => { r = 0; }, } var fresh = [11, 22, 33]; var s = fresh[0] + fresh[1] + fresh[2]; if (r != 4) { return 90; } if (s != 66) { return 91; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"option-arr-binding-escapes-detector", `function go(): i32 { var o: Option[i32[]] = Some([7, 8, 9]); var out: i32[] = [0]; match (o) { Some(v) => { out = v; }, None => {} } var r = out[0] + out[2]; if (r != 16) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"option-arr-used-after-detector", `function go(): i32 { var o: Option[i32[]] = Some([1, 2, 3]); var a = 0; match (o) { Some(v) => { a = v[0]; }, None => { a = 0; }, } var b = 0; match (o) { Some(v) => { b = v[1]; }, None => { b = 0; }, } if (a + b != 3) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		// NON-firing (escapes / returned): a returned Option is moved to the caller, so
		// mk must NOT free it (nor its array). Detector 0.
		{"option-arr-escapes-not-freed-detector", `function mk(): Option[i32[]] { var o: Option[i32[]] = Some([1, 2, 3]); return o; } function main(): i32 { var o = mk(); var r = 0; match (o) { Some(v) => { r = v[0] + v[2]; }, None => { r = 0; }, } if (r != 4) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		// `__rc_underflow_count()==0` pin the payload box AND the option box freed once each.
		...
		{"option-struct-payload-detector", `struct P { x: i32, y: i32 } function go(): i32 { var o: Option[P] = Some(P { x: 3, y: 4 }); var r = 0; match (o) { Some(p) => { r = p.x + p.y; }, None => { r = 0; }, } if (r != 7) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		// Un-annotated Some(P{..}) (Option infers the single param from the literal).
		{"option-struct-payload-unannotated-detector", `struct P { x: i32, y: i32 } function go(): i32 { var o = Some(P { x: 3, y: 4 }); var r = 0; match (o) { Some(p) => { r = p.x + p.y; }, None => { r = 0; }, } if (r != 7) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		// Result Ok(P{..}) struct payload freed the same way (tag 0).
		{"result-ok-struct-payload-detector", `struct P { x: i32, y: i32 } function go(): i32 { var r: Result[P, i32] = Ok(P { x: 5, y: 6 }); var v = 0; match (r) { Ok(p) => { v = p.x + p.y; }, Err(e) => { v = e; }, } if (v != 11) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"option-struct-arrfield-payload-detector", `struct Buf { xs: i32[], n: i32 } function go(): i32 { var o: Option[Buf] = Some(Buf { xs: [10, 20, 30], n: 3 }); var r = 0; match (o) { Some(b) => { r = b.xs[1] + b.n; }, None => { r = 0; } } if (r != 23) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		// Wildcard arm (no binding / no field read) — still shallow-freed cleanly.
		{"option-struct-arrfield-wildcard-detector", `struct Buf { xs: i32[], n: i32 } function go(): i32 { var o: Option[Buf] = Some(Buf { xs: [10, 20, 30], n: 3 }); var r = 0; match (o) { Some(_) => { r = 5; }, None => { r = 0; } } if (r != 5) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"option-struct-arrfield-corruption-probe-detector", `struct Buf { xs: i32[], n: i32 } function go(): i32 { var o: Option[Buf] = Some(Buf { xs: [10, 20, 30], n: 3 }); var r = 0; match (o) { Some(b) => { r = b.xs[0] + b.xs[2]; }, None => { r = 0; } } var fresh = [11, 22, 33]; var s = fresh[0] + fresh[1] + fresh[2]; if (r != 40) { return 90; } if (s != 66) { return 91; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"option-struct-payload-corruption-probe-detector", `struct P { x: i32, y: i32 } function go(): i32 { var o: Option[P] = Some(P { x: 3, y: 4 }); var r = 0; match (o) { Some(p) => { r = p.x + p.y; }, None => { r = 0; }, } var fresh = [11, 22, 33]; var s = fresh[0] + fresh[1] + fresh[2]; if (r != 7) { return 90; } if (s != 66) { return 91; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"option-struct-bareident-not-freed-detector", `struct P { x: i32, y: i32 } function go(): i32 { var p = P { x: 3, y: 4 }; var o: Option[P] = Some(p); var r = 0; match (o) { Some(q) => { r = q.x + q.y; }, None => { r = 0; }, } if (r != 7) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"option-struct-binding-escapes-detector", `struct P { x: i32, y: i32 } function go(): i32 { var o: Option[P] = Some(P { x: 3, y: 4 }); var keep = P { x: 0, y: 0 }; match (o) { Some(p) => { keep = p; }, None => {} } var r = keep.x + keep.y; if (r != 7) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"option-precise-if-detector", `function f(n: i32): i32 { var o: Option[i32] = Some(3); var c = 0; if (n > 0) { match (o) { Some(v) => { c = v; }, None => { c = 0; } } } return c + n; } function main(): i32 { var r = f(5); if (r != 8) { return 99; } return __rc_underflow_count(); }`, 0},
		// A None box (payloadless, rc-headered via opt_none) is precise-dropped the same.
		{"option-precise-none-detector", `function f(n: i32): i32 { var o: Option[i32] = None; var c = 0; if (n > 0) { match (o) { Some(v) => { c = v; }, None => { c = 9; } } } return c + n; } function main(): i32 { var r = f(5); if (r != 14) { return 99; } return __rc_underflow_count(); }`, 0},
		// Result last-used in a nested if-match — precise-dropped the same way.
		{"result-precise-if-detector", `function f(n: i32): i32 { var r: Result[i32, i32] = Ok(4); var c = 0; if (n > 0) { match (r) { Ok(v) => { c = v; }, Err(e) => { c = e; } } } return c + n; } function main(): i32 { var z = f(5); if (z != 9) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"option-precise-corruption-probe-detector", `function go(): i32 { var o: Option[i32] = Some(3); var c = 0; var i = 0; while (i < 1) { match (o) { Some(v) => { c = v; }, None => {} } i = i + 1; } var fresh = [11, 22, 33]; var s = fresh[0] + fresh[1] + fresh[2]; if (c != 3) { return 90; } if (s != 66) { return 91; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"option-toplevel-match-not-double-freed-detector", `function go(): i32 { var o: Option[i32] = Some(7); var r = 0; match (o) { Some(v) => { r = v; }, None => { r = 0; } } if (r != 7) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"option-arr-precise-if-detector", `function f(n: i32): i32 { var o: Option[i32[]] = Some([10, 20, 30]); var c = 0; if (n > 0) { match (o) { Some(v) => { c = v[0] + v[2]; }, None => {} } } return c + n; } function main(): i32 { var r = f(5); if (r != 45) { return 99; } return __rc_underflow_count(); }`, 0},
		// Scalar-struct payload option, nested-block last use — payload box + option box
		// freed after the if.
		{"option-struct-precise-if-detector", `struct P { x: i32, y: i32 } function f(n: i32): i32 { var o: Option[P] = Some(P { x: 3, y: 4 }); var c = 0; if (n > 0) { match (o) { Some(p) => { c = p.x + p.y; }, None => {} } } return c + n; } function main(): i32 { var r = f(5); if (r != 12) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"option-arrfield-struct-precise-if-detector", `struct Buf { xs: i32[], n: i32 } function f(k: i32): i32 { var o: Option[Buf] = Some(Buf { xs: [10, 20, 30], n: 3 }); var c = 0; if (k > 0) { match (o) { Some(b) => { c = b.xs[1] + b.n; }, None => {} } } return c + k; } function main(): i32 { var r = f(5); if (r != 28) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"option-arr-precise-corruption-probe-detector", `function go(): i32 { var o: Option[i32[]] = Some([1, 2, 3]); var c = 0; var i = 0; while (i < 1) { match (o) { Some(v) => { c = v[0] + v[2]; }, None => {} } i = i + 1; } var fresh = [11, 22, 33]; var s = fresh[0] + fresh[1] + fresh[2]; if (c != 4) { return 90; } if (s != 66) { return 91; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"option-arr-precise-binding-escapes-detector", `function go(): i32 { var o: Option[i32[]] = Some([7, 8, 9]); var out: i32[] = [0]; if (true) { match (o) { Some(v) => { out = v; }, None => {} } } var r = out[0] + out[2]; if (r != 16) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"result-scalar-precise-if-detector", `function f(n: i32): i32 { var r: Result[i32, i32] = Ok(4); var c = 0; if (n > 0) { match (r) { Ok(v) => { c = v; }, Err(e) => { c = e; } } } return c + n; } function main(): i32 { var z = f(5); if (z != 9) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"result-arr-ok-precise-if-detector", `function f(n: i32): i32 { var r: Result[i32[], i32] = Ok([10, 20, 30]); var c = 0; if (n > 0) { match (r) { Ok(v) => { c = v[0] + v[2]; }, Err(e) => { c = e; } } } return c + n; } function main(): i32 { var z = f(5); if (z != 45) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"result-arr-err-precise-if-detector", `function f(n: i32): i32 { var r: Result[i32, i32[]] = Err([3, 4, 5]); var c = 0; if (n > 0) { match (r) { Ok(v) => { c = v; }, Err(e) => { c = e[0] + e[2]; } } } return c + n; } function main(): i32 { var z = f(5); if (z != 13) { return 99; } return __rc_underflow_count(); }`, 0},
		// rc-PAYLOAD Result precise-drop, scalar-STRUCT Ok payload.
		{"result-struct-precise-if-detector", `struct P { x: i32, y: i32 } function f(n: i32): i32 { var r: Result[P, i32] = Ok(P { x: 3, y: 4 }); var c = 0; if (n > 0) { match (r) { Ok(p) => { c = p.x + p.y; }, Err(e) => { c = e; } } } return c + n; } function main(): i32 { var z = f(5); if (z != 12) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"enum-scalar-precise-if-detector", `enum Shape { Circle(i32), Square(i32) } function f(n: i32): i32 { var x = Circle(7); var c = 0; if (n > 0) { match (x) { Circle(r) => { c = r + r; }, Square(w) => { c = w; } } } return c + n; } function main(): i32 { var z = f(5); if (z != 19) { return 99; } return __rc_underflow_count(); }`, 0},
		// Annotated variant (`var x: Shape = Square(6)`) — same free.
		{"enum-annotated-precise-if-detector", `enum Shape { Circle(i32), Square(i32) } function f(n: i32): i32 { var x: Shape = Square(6); var c = 0; if (n > 0) { match (x) { Circle(r) => { c = r; }, Square(w) => { c = w * 2; } } } return c + n; } function main(): i32 { var z = f(5); if (z != 17) { return 99; } return __rc_underflow_count(); }`, 0},
		// PRECISE drop + corruption probe: a fresh array after the enum's precise drop
		// reads back intact (the early box free was sound).
		{"enum-scalar-precise-corruption-probe-detector", `enum Shape { Circle(i32), Square(i32) } function go(): i32 { var x = Circle(7); var c = 0; var i = 0; while (i < 1) { match (x) { Circle(r) => { c = r; }, Square(w) => { c = w; } } i = i + 1; } var fresh = [11, 22, 33]; var s = fresh[0] + fresh[1] + fresh[2]; if (c != 7) { return 90; } if (s != 66) { return 91; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"enum-toplevel-match-not-double-freed-detector", `enum Shape { Circle(i32), Square(i32) } function go(): i32 { var x = Circle(7); var t = 0; match (x) { Circle(r) => { t = r + r; }, Square(w) => { t = w * w; } } if (t != 14) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"enum-arr-precise-if-detector", `enum Shape { Poly(i32[]), Dot(i32) } function f(n: i32): i32 { var x = Poly([10, 20, 30]); var c = 0; if (n > 0) { match (x) { Poly(a) => { c = a[0] + a[2]; }, Dot(d) => { c = d; } } } return c + n; } function main(): i32 { var z = f(5); if (z != 45) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"enum-struct-precise-if-detector", `struct Buf { xs: i32[], n: i32 } enum E { V(Buf), W(i32) } function f(n: i32): i32 { var x = V(Buf { xs: [10, 20, 30], n: 3 }); var c = 0; if (n > 0) { match (x) { V(b) => { c = b.xs[1] + b.n; }, W(k) => { c = k; } } } return c + n; } function main(): i32 { var z = f(5); if (z != 28) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"enum-arr-precise-binding-escapes-detector", `enum Shape { Poly(i32[]), Dot(i32) } function go(): i32 { var x = Poly([7, 8, 9]); var out: i32[] = [0]; if (true) { match (x) { Poly(a) => { out = a; }, Dot(d) => {} } } var r = out[0] + out[2]; if (r != 16) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"struct-array-field-reclaim-detector", `struct Buf { xs: i32[], n: i32 } function main(): i32 { var b = Buf { xs: [10, 20, 30], n: 3 }; var r = b.xs[1] + b.n; if (r != 23) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"struct-arr-field-from-var-detector", `struct Box { v: i32[] } function main(): i32 { var a = [1, 2, 3]; var b = Box { v: a }; var r = b.v[0]; if (r != 1) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"struct-arr-field-two-alias-detector", `struct Box { v: i32[] } function main(): i32 { var a = [1, 2, 3]; var b = Box { v: a }; var c = Box { v: a }; var r = b.v[0] + c.v[1]; if (r != 3) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"field-arr-bind-detector", `struct H { items: i32[] } function main(): i32 { var h = H { items: [10, 20, 30] }; var y = h.items; var r = y[0] + y[2]; if (r != 40) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"field-arr-bind-param-detector", `struct H { items: i32[] } function f(h: H): i32 { var y = h.items; var r = y[1]; return r; } function main(): i32 { var h = H { items: [5, 6, 7] }; var v = f(h); if (v != 6) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"field-arr-return-detector", `struct H { items: i32[] } function get(h: H): i32[] { return h.items; } function main(): i32 { var h = H { items: [11, 22, 33] }; var xs = get(h); var r = xs[0] + xs[2]; if (r != 44) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		// detector 0.
		{"field-arr-return-owned-detector", `struct H { items: i32[] } function mk(): i32[] { var h = H { items: [4, 5, 6] }; return h.items; } function main(): i32 { var xs = mk(); var r = xs[0] + xs[1] + xs[2]; if (r != 15) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"field-arr-assign-detector", `struct H { items: i32[] } function main(): i32 { var h = H { items: [7, 8, 9] }; var x = [1, 2, 3]; var pre = x[1]; x = h.items; var r = x[0] + x[2]; if (pre != 2) { return 98; } if (r != 16) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"field-arr-assign-f64-detector", `struct H { items: f64[] } function main(): i32 { var h = H { items: [1.5, 2.5, 3.0] }; var x: f64[] = [0.5, 0.5]; x = h.items; var s = x[0] + x[2]; if ((s as i32) != 4) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"field-copy-scalar-detector", `struct S { xs: i32[], n: i32 } function main(): i32 { var s = S { xs: [10, 20, 30], n: 3 }; var s2 = S { xs: s.xs, n: s.n }; var r = s2.xs[1] + s2.n; if (r != 23) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		// i64[] too).
		{"field-copy-i64-detector", `struct S { xs: i64[], n: i32 } function main(): i32 { var s = S { xs: [100, 200, 300], n: 3 }; var s2 = S { xs: s.xs, n: s.n }; var v: i64 = s2.xs[0]; var r = (v as i32) + s2.n; if (r != 103) { return 99; } return __rc_underflow_count(); }`, 0},
		// f64[] field-copy: same through the 8-byte float-element array.
		{"field-copy-f64-detector", `struct S { xs: f64[], n: i32 } function main(): i32 { var s = S { xs: [1.5, 2.5, 3.0], n: 2 }; var s2 = S { xs: s.xs, n: s.n }; var r = (s2.xs[0] as i32) + s2.n; if (r != 3) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"field-copy-struct-arr-detector", `struct Point { x: i32, y: i32 } struct S { pts: Point[] } function main(): i32 { var s = S { pts: [Point { x: 3, y: 4 }, Point { x: 5, y: 6 }] }; var s2 = S { pts: s.pts }; var r = s2.pts[0].x + s2.pts[1].y; if (r != 9) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"consumed-enum-free-detector", `enum Shape { Circle(i32), Square(i32) } function main(): i32 { var x = Circle(7); var total = 0; match (x) { Circle(r) => { total = r + r; }, Square(w) => { total = w * w; }, } if (total != 14) { return 99; } return __rc_underflow_count(); }`, 0},
		// i64-payload scalar enum is also a candidate (i64 is a flat scalar) — freed
		// once, detector 0.
		{"consumed-enum-i64-detector", `enum Big { L(i64), R(i32) } function main(): i32 { var x = L(100); var total = 0; match (x) { L(v) => { total = v as i32; }, R(n) => { total = n; }, } if (total != 100) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"escaping-enum-not-freed-detector", `enum Shape { Circle(i32), Square(i32) } function area(s: Shape): i32 { match (s) { Circle(r) => { return r + r; }, Square(w) => { return w * w; }, } return 0; } function main(): i32 { var x = Circle(7); var a = area(x); if (a != 14) { return 99; } return __rc_underflow_count(); }`, 0},
		// NON-firing: x is RETURNED from mk (moved to caller), so mk must NOT free it.
		// Detector 0.
		{"returned-enum-not-freed-detector", `enum Shape { Circle(i32), Square(i32) } function mk(): Shape { var x = Circle(7); return x; } function main(): i32 { var s = mk(); var total = 0; match (s) { Circle(r) => { total = r; }, Square(w) => { total = w; }, } if (total != 7) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"string-payload-enum-freed-detector", `enum Tok { Word(string), Num(i32) } function main(): i32 { var x = Num(7); var total = 0; match (x) { Word(s) => { total = s.len(); }, Num(n) => { total = n; }, } if (total != 7) { return 99; } return __rc_underflow_count(); }`, 0},
		// NON-firing: x is used AFTER the match (`snd(x)`), so it is not dead — must
		// NOT be freed. Detector 0.
		{"enum-used-after-match-not-freed-detector", `enum Shape { Circle(i32), Square(i32) } function snd(s: Shape): i32 { return 1; } function main(): i32 { var x = Circle(7); var total = 0; match (x) { Circle(r) => { total = r; }, Square(w) => { total = w; }, } var g = snd(x); if (total + g != 8) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"enum-donor-reuse-detector", `enum E { A(i32, i32), B(i32, i32) } struct W { p: i32, q: i32 } function main(): i32 { var x = A(10, 20); var t = 0; match (x) { A(a, b) => { t = a + b; }, B(c, d) => { t = c - d; }, } var y = W { p: 3, q: 4 }; var s = t + y.p + y.q; if (s != 37) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"enum-donor-reuse-array-field-detector", `enum E { A(i32, i32), B(i32, i32) } struct W { p: i32, xs: i32[] } function main(): i32 { var x = A(10, 20); var t = 0; match (x) { A(a, b) => { t = a + b; }, B(c, d) => { t = c - d; }, } var y = W { p: 5, xs: [7, 8] }; var s = t + y.p + y.xs[0] + y.xs[1]; if (s != 50) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"enum-donor-no-reuse-diff-size-detector", `enum E { A(i32, i32), B(i32, i32) } struct W { p: i32, q: i32, r: i32 } function main(): i32 { var x = A(10, 20); var t = 0; match (x) { A(a, b) => { t = a + b; }, B(c, d) => { t = c - d; }, } var y = W { p: 3, q: 4, r: 5 }; var s = t + y.p + y.q + y.r; if (s != 42) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"enum-donor-no-reuse-used-after-detector", `enum E { A(i32, i32), B(i32, i32) } struct W { p: i32, q: i32 } function main(): i32 { var x = A(10, 20); var t = 0; match (x) { A(a, b) => { t = a + b; }, B(c, d) => { t = c - d; }, } var y = W { p: 3, q: 4 }; var u = 0; match (x) { A(a, b) => { u = a; }, B(c, d) => { u = c; }, } var s = t + y.p + y.q + u; if (s != 47) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"enum-donor-reuse-recipient-escapes-detector", `enum E { A(i32, i32), B(i32, i32) } struct W { p: i32, q: i32 } function mk(): W { var x = A(10, 20); var t = 0; match (x) { A(a, b) => { t = a + b; }, B(c, d) => { t = c - d; }, } var y = W { p: t, q: 4 }; return y; } function main(): i32 { var w = mk(); if (w.p + w.q != 34) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"rc-enum-arr-free-detector", `enum E { V(i32[]), N } function go(): i32 { var x = V([1, 2, 3]); var r = 0; match (x) { V(_) => { r = 5; }, N => { r = 2; }, } if (r != 5) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"rc-enum-multi-variant-arr-detector", `enum E { A(i32[]), B(i32[]) } function go(): i32 { var x = B([4, 5]); var r = 0; match (x) { A(_) => { r = 1; }, B(_) => { r = 2; }, } if (r != 2) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"rc-enum-f64arr-free-detector", `enum E { V(f64[]), N } function go(): i32 { var x = V([1.5, 2.5]); var r = 0; match (x) { V(_) => { r = 7; }, N => { r = 2; }, } if (r != 7) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"rc-enum-arm-binds-payload-borrow-detector", `enum E { V(i32[]), N } function go(): i32 { var x = V([10, 20, 30]); var r = 0; match (x) { V(a) => { r = a[0]; }, N => { r = 0; }, } if (r != 10) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"rc-enum-arm-binds-payload-escape-detector", `enum E { V(i32[]), N } function go(): i32 { var x = V([10, 20, 30]); var out: i32[] = []; match (x) { V(a) => { out = a; }, N => {}, } var r: i32 = out[0]; if (r != 10) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"rc-enum-used-after-match-detector", `enum E { V(i32[]), N } function go(): i32 { var x = V([3, 4]); var a = 0; match (x) { V(_) => { a = 1; }, N => { a = 0; }, } var b = 0; match (x) { V(_) => { b = 2; }, N => { b = 0; }, } if (a + b != 3) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"inarm-reuse-detector", `enum E { V(i32, i32), W(i32, i32) } function go(): i32 { var x = V(3, 4); var y = match (x) { V(a, b) => W(a + 1, b + 1), W(c, d) => V(c, d) }; var r = match (y) { V(a, b) => a + b, W(c, d) => c + d }; if (r != 9) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"inarm-no-reuse-diff-size-detector", `enum E { V(i32, i32), W(i32) } function go(): i32 { var x = V(3, 4); var y = match (x) { V(a, b) => W(a + b), W(c) => V(c, c) }; var r = match (y) { V(a, b) => a + b, W(c) => c }; if (r != 7) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		// detector 0.
		{"inarm-no-reuse-escapes-detector", `enum E { V(i32, i32), W(i32, i32) } function use_x(e: E): i32 { return 1; } function go(): i32 { var x = V(3, 4); var y = match (x) { V(a, b) => W(a + 1, b + 1), W(c, d) => V(c, d) }; var g = use_x(x); var r = match (y) { V(a, b) => a + b, W(c, d) => c + d }; if (r + g != 10) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"inarm-reuse-i64-detector", `enum E { V(i64, i64), W(i64, i64) } function go(): i32 { var x = V(3, 4); var y = match (x) { V(a, b) => W(a + 1, b + 1), W(c, d) => V(c, d) }; var r: i64 = 0; match (y) { V(a, b) => { r = a + b; }, W(c, d) => { r = c + d; } } if (r as i32 != 9) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"inarm-reuse-f64-detector", `enum E { V(f64, f64), W(f64, f64) } function go(): i32 { var x = V(3.0, 4.0); var y = match (x) { V(a, b) => W(a + 1.0, b + 1.0), W(c, d) => V(c, d) }; var r: f64 = 0.0; match (y) { V(a, b) => { r = a + b; }, W(c, d) => { r = c + d; } } if (r as i32 != 9) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"inarm-reuse-boolean-detector", `enum E { V(boolean, boolean), W(boolean, boolean) } function go(): i32 { var x = V(true, false); var y = match (x) { V(a, b) => W(!a, !b), W(c, d) => V(c, d) }; var r = 0; match (y) { V(a, b) => { r = 0; }, W(c, d) => { if (c) { r = r + 10; } if (d) { r = r + 1; } } } if (r != 1) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		// FIRING u32: V(u32,u32)→W(a+1,b+1); W(4,5) read back → 4+5 = 9 (i32-shaped).
		{"inarm-reuse-u32-detector", `enum E { V(u32, u32), W(u32, u32) } function go(): i32 { var x = V(3, 4); var y = match (x) { V(a, b) => W(a + 1, b + 1), W(c, d) => V(c, d) }; var r = 0; match (y) { V(a, b) => { r = (a + b) as i32; }, W(c, d) => { r = (c + d) as i32; } } if (r != 9) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"inarm-reuse-array-move-detector", `enum E { V(i32, i32[]), W(i32, i32[]) } function go(): i32 { var x = V(3, [10, 20, 30]); var y = match (x) { V(a, xs) => W(a + 1, xs), W(b, ys) => V(b, ys) }; var r = 0; match (y) { V(a, xs) => { r = a + xs[0] + xs[1] + xs[2]; }, W(c, ds) => { r = c + ds[0] + ds[1] + ds[2]; } } if (r != 64) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"inarm-reuse-array-move-corruption-probe-detector", `enum E { V(i32, i32[]), W(i32, i32[]) } function go(): i32 { var x = V(3, [10, 20, 30]); var y = match (x) { V(a, xs) => W(a + 1, xs), W(b, ys) => V(b, ys) }; var r = 0; match (y) { V(a, xs) => { r = a + xs[0] + xs[1] + xs[2]; }, W(c, ds) => { r = c + ds[0] + ds[1] + ds[2]; } } var fresh = [11, 22, 33]; var s = fresh[0] + fresh[1] + fresh[2]; if (r != 64) { return 90; } if (s != 66) { return 91; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"inarm-reuse-array-replace-detector", `enum E { V(i32, i32[]), W(i32, i32[]) } function go(): i32 { var x = V(3, [10, 20, 30]); var y = match (x) { V(a, xs) => W(a, [7, 8]), W(b, ys) => V(b, ys) }; var r = 0; match (y) { V(a, xs) => { r = a + xs[0] + xs[1]; }, W(c, ds) => { r = c + ds[0] + ds[1]; } } if (r != 18) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"inarm-reuse-array-replace-corruption-probe-detector", `enum E { V(i32, i32[]), W(i32, i32[]) } function go(): i32 { var x = V(3, [10, 20, 30]); var y = match (x) { V(a, xs) => W(a, [7, 8]), W(b, ys) => V(b, ys) }; var r = 0; match (y) { V(a, xs) => { r = a + xs[0] + xs[1]; }, W(c, ds) => { r = c + ds[0] + ds[1]; } } var fresh = [11, 22, 33]; var s = fresh[0] + fresh[1] + fresh[2]; if (r != 18) { return 90; } if (s != 66) { return 91; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"inarm-reuse-array-mixed-i64-detector", `enum E { V(i64, i32[]), W(i64, i32[]) } function go(): i32 { var x = V(5, [10, 20]); var y = match (x) { V(a, xs) => W(a + 1, xs), W(b, ys) => V(b, ys) }; var r = 0; match (y) { V(a, xs) => { r = (a as i32) + xs[0] + xs[1]; }, W(c, ds) => { r = (c as i32) + ds[0] + ds[1]; } } if (r != 36) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"iife-match-arr-payload-detector", `enum E { V(i32[]), W(i32[]) } function go(): i32 { var x: E = E.V([10, 20, 30]); var r = match (x) { V(xs) => xs[0], W(ys) => ys[0] }; if (r != 10) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"iife-match-struct-payload-detector", `struct P { x: i32 } enum E { V(P), N } function go(): i32 { var e: E = E.V(P { x: 42 }); var r = match (e) { V(p) => p.x, N => 0 }; if (r != 42) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"iife-match-string-payload-detector", `enum E { V(string), N } function go(): i32 { var e: E = E.V("world"); var r = match (e) { V(s) => s.len(), N => 0 }; if (r != 5) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"with-value-expr-detector", `function main(): i32 { var a = [1, 2, 3]; var b = a.with(1, 99); if (b[1] + a[1] != 101) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"with-value-i64-detector", `function main(): i32 { var a: i64[] = [10, 20, 30]; var b = a.with(0, 100); if ((b[0] + a[0]) as i32 != 110) { return 99; } return __rc_underflow_count(); }`, 0},
		{"with-value-f64-detector", `function main(): i32 { var a: f64[] = [1.5, 2.5, 3.0]; var b = a.with(2, 9.0); if (((b[2] + a[2]) as i32) != 12) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"append-value-field-detector", `struct Buf { xs: i32[], n: i32 } function main(): i32 { var s = Buf { xs: [1, 2, 3], n: 3 }; var t = Buf { xs: s.xs.append(4), n: s.n + 1 }; var r = t.xs[3] + s.xs.len() + t.n; if (r != 11) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"struct-field-with-detector", `struct State { xs: i32[], n: i32 } function main(): i32 { var s = State { xs: [1, 2, 3], n: 3 }; var t = State { xs: s.xs.with(1, 99), n: s.n }; if (t.xs[1] + s.xs[1] != 101) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"struct-field-append-detector", `struct State { xs: i32[], n: i32 } function main(): i32 { var s = State { xs: [1, 2, 3], n: 3 }; var t = State { xs: s.xs.append(4), n: s.n + 1 }; if (t.xs[3] != 4) { return 98; } if (s.xs.len() != 3) { return 97; } return __rc_underflow_count(); }`, 0},
		// i64[]-field and f64[]-field struct updates.
		{"struct-field-with-i64-detector", `struct State { xs: i64[], n: i32 } function main(): i32 { var s = State { xs: [10, 20, 30], n: 3 }; var t = State { xs: s.xs.with(0, 100), n: s.n }; if (((t.xs[0] + s.xs[0]) as i32) != 110) { return 99; } return __rc_underflow_count(); }`, 0},
		{"struct-field-with-f64-detector", `struct State { xs: f64[], n: i32 } function main(): i32 { var s = State { xs: [1.5, 2.5, 3.0], n: 3 }; var t = State { xs: s.xs.with(2, 9.0), n: s.n }; if ((((t.xs[2] + s.xs[2]) as i32)) != 12) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"struct-field-with-chain-detector", `struct State { xs: i32[], n: i32 } function main(): i32 { var s = State { xs: [1, 2, 3], n: 3 }; var t = State { xs: s.xs.with(1, 99), n: s.n }; var u = State { xs: t.xs.with(2, 42), n: t.n }; if (u.xs[1] != 99) { return 98; } if (u.xs[2] != 42) { return 97; } if (s.xs[1] != 2) { return 96; } if (t.xs[2] != 3) { return 95; } return __rc_underflow_count(); }`, 0},
		...
		// exactly once — no leak, no double-free through the inlined match path).
		{"iife-match-string-bare-payload-detector", `enum E { V(string), N } function go(): i32 { var e: E = E.V("hello"); var s: string = match (e) { V(x) => x, N => "z" }; if (s.len() != 5) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"iife-match-string-struct-field-detector", `struct P { name: string } enum E { V(P), N } function go(): i32 { var e: E = E.V(P { name: "world" }); var s: string = match (e) { V(p) => p.name, N => "zz" }; if (s.len() != 5) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"iife-match-string-concat-detector", `enum E { V(string), N } function go(): i32 { var e: E = E.V("hi"); var s: string = match (e) { V(x) => x + "!", N => "z" }; if (s.len() != 3) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"iife-match-string-concat-struct-field-detector", `struct P { name: string } enum E { V(P), N } function go(): i32 { var e: E = E.V(P { name: "world" }); var s: string = match (e) { V(p) => p.name + "!", N => "zz" }; if (s.len() != 6) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"iife-match-struct-payload-detector", `struct P { x: i32 } enum E { V(P), N } function go(): i32 { var e: E = E.V(P { x: 7 }); var p: P = match (e) { V(q) => q, N => P { x: 0 } }; if (p.x != 7) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"iife-match-enum-payload-detector", `enum Inner { A(i32), B } enum Outer { W(Inner), Z } function go(): i32 { var o: Outer = Outer.W(Inner.A(5)); var p: Inner = match (o) { W(q) => q, Z => Inner.B }; var r = match (p) { A(n) => n, B => 99 }; if (r != 5) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"iife-match-tuple-payload-detector", `enum E { V((i32, i32)), N } function go(): i32 { var e: E = E.V((3, 4)); var p: (i32, i32) = match (e) { V(q) => q, N => (0, 0) }; if (p.0 + p.1 != 7) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		// cases pin that soundness (`__rc_underflow_count() == 0`): a regression guard for the
		...
		{"nonleaksafe-string-field-reclaim-detector", `struct P { name: string, n: i32 } function go(): i32 { var p = P { name: "hello", n: 7 }; return p.n; } function main(): i32 { var r = go(); if (r != 7) { return 99; } return __rc_underflow_count(); }`, 0},
		{"nonleaksafe-strarr-field-reclaim-detector", `struct Doc { lines: string[], n: i32 } function go(): i32 { var d = Doc { lines: ["a", "b", "c"], n: 3 }; return d.n; } function main(): i32 { var r = go(); if (r != 3) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"nonleaksafe-nested-struct-reclaim-detector", `struct Inner { xs: i32[] } struct Outer { inner: Inner, n: i32 } function go(): i32 { var o = Outer { inner: Inner { xs: [10, 20, 30] }, n: 5 }; return o.inner.xs[1] + o.n; } function main(): i32 { var r = go(); if (r != 25) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"nonleaksafe-struct-array-reclaim-detector", `struct Item { v: i32 } struct Bag { items: Item[], n: i32 } function go(): i32 { var b = Bag { items: [Item { v: 10 }, Item { v: 20 }], n: 2 }; return b.items[0].v + b.items[1].v + b.n; } function main(): i32 { var r = go(); if (r != 32) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"nonleaksafe-reassign-frees-old-detector", `struct P { name: string } function main(): i32 { var p = P { name: "first" }; p = P { name: "second" }; if (p.name.len() != 6) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		// transforms `.to_ascii_upper()` / `.to_ascii_lower()` / `.repeat(n)`
		...
		{"strdrop-literal-field-detector", `struct P { name: string, n: i32 } function go(): i32 { var p = P { name: "hello", n: 4 }; return p.n; } function main(): i32 { var r = go(); if (r != 4) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"strdrop-aliased-local-detector", `struct P { name: string } function go(): i32 { var s = "shared"; var p = P { name: s }; var r = s.len() + p.name.len(); return r; } function main(): i32 { var r = go(); if (r != 12) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"strdrop-two-alias-detector", `struct P { name: string } function go(): i32 { var s = "x"; var a = P { name: s }; var b = P { name: s }; var r = a.name.len() + b.name.len(); return r; } function main(): i32 { var r = go(); if (r != 2) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"arrdrop-two-alias-detector", `struct Q { v: i32[] } function go(): i32 { var s: i32[] = [1, 2]; var a: Q = Q { v: s }; var b: Q = Q { v: s }; var r: i32 = a.v.len() + b.v.len(); return r; } function main(): i32 { var r: i32 = go(); if (r != 4) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"strdrop-return-field-detector", `struct P { name: string } function mk(): string { var p = P { name: "hi" }; return p.name; } function main(): i32 { var s = mk(); if (s.len() != 2) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		// the fresh box).
		{"strdrop-concat-field-detector", `struct P { name: string } function go(): i32 { var a = "ab"; var p = P { name: a + "c" }; return p.name.len(); } function main(): i32 { var r = go(); if (r != 3) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"strdrop-chr-field-detector", `struct P { name: string } function go(): i32 { var p = P { name: chr(65) }; return p.name.len(); } function main(): i32 { var r = go(); if (r != 1) { return 99; } return __rc_underflow_count(); }`, 0},
		// `string_from_bytes_unchecked(arr)`: packs bytes into a fresh box, freed once.
		{"strdrop-string-from-bytes-field-detector", `struct P { name: string } function go(): i32 { var b: u8[] = [104, 105]; var p = P { name: string_from_bytes_unchecked(b) }; return p.name.len(); } function main(): i32 { var r = go(); if (r != 2) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"iife-match-i64-struct-field-detector", `struct P { v: i64 } enum E { V(P), N } function go(): i32 { var e: E = E.V(P { v: 42 }); var r: i64 = match (e) { V(p) => p.v, N => 0 }; if (r as i32 != 42) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"iife-match-f64-struct-field-detector", `struct P { v: f64 } enum E { V(P), N } function go(): i32 { var e: E = E.V(P { v: 42.5 }); var r: f64 = match (e) { V(p) => p.v, N => 0.0 }; if (r as i32 != 42) { return 99; } return __rc_underflow_count(); } function main(): i32 { return go(); }`, 0},
		...
		{"tuple-field-reuse-override-detector", `struct P { id: i32, pr: (i32, i32) } function main(): i32 { var d = P { id: 1, pr: (10, 20) }; var c = P { ...d, pr: (7, 8) }; var s: i32 = c.pr.0 + c.pr.1 + c.id; if (s != 16) { return 99; } return __rc_underflow_count(); }`, 0},
		{"tuple-field-reuse-cross-detector", `struct P { id: i32, pr: (i32, i32) } function main(): i32 { var d = P { id: 1, pr: (10, 20) }; var u: i32 = d.pr.0 + d.id; var c = P { id: 2, pr: (7, 8) }; var s: i32 = c.pr.0 + c.pr.1 + c.id + u; if (s != 28) { return 99; } return __rc_underflow_count(); }`, 0},
		{"tuple-field-reuse-corruption-probe-detector", `struct P { id: i32, pr: (i32, i32) } function main(): i32 { var d = P { id: 1, pr: (10, 20) }; var c = P { ...d, pr: (7, 8) }; var fresh = [11, 22, 33]; var s: i32 = fresh[0] + fresh[1] + fresh[2]; if (c.pr.0 + c.pr.1 + c.id != 16) { return 90; } if (s != 66) { return 91; } return __rc_underflow_count(); }`, 0},
		...
		{"option-field-reuse-override-detector", `struct Q { id: i32, o: Option[i32] } function main(): i32 { var d = Q { id: 1, o: Some(10) }; var c = Q { ...d, o: Some(30) }; var r: i32 = 0; match (c.o) { Some(v) => { r = v + c.id; }, None => { r = 0; } } if (r != 31) { return 99; } return __rc_underflow_count(); }`, 0},
		...
		{"own-param-donor-detector", `struct P { x: i32, y: i32 } function bump(own d: P): i32 { var u: i32 = d.x + d.y; var c = P { x: 10, y: 20 }; var s: i32 = c.x + c.y + u; if (s != 37) { return 99; } return __rc_underflow_count(); } function main(): i32 { return bump(P { x: 3, y: 4 }); }`, 0},
		{"own-param-donor-cross-detector", `struct A { n: i32, m: i32 } struct B { p: i32, q: i32 } function f(own d: A): i32 { var u: i32 = d.n + d.m; var c = B { p: 10, q: 20 }; var s: i32 = c.p + c.q + u; if (s != 37) { return 99; } return __rc_underflow_count(); } function main(): i32 { return f(A { n: 3, m: 4 }); }`, 0},
		{"own-param-donor-corruption-probe-detector", `struct P { x: i32, y: i32 } function bump(own d: P): i32 { var u: i32 = d.x + d.y; var c = P { x: 10, y: 20 }; var fresh = [11, 22, 33]; var s: i32 = fresh[0] + fresh[1] + fresh[2]; if (c.x + c.y + u != 37) { return 90; } if (s != 66) { return 91; } return __rc_underflow_count(); } function main(): i32 { return bump(P { x: 3, y: 4 }); }`, 0},
		...
		{"own-param-donor-array-detector", `struct H { id: i32, items: i32[] } function bump(own d: H): i32 { var u: i32 = d.id + d.items[0]; var c = H { id: 5, items: [7, 8, 9] }; var s: i32 = c.id + c.items[0] + c.items[2] + u; if (s != 32) { return 99; } return __rc_underflow_count(); } function main(): i32 { return bump(H { id: 1, items: [10, 20] }); }`, 0},
		...
		{"own-param-donor-nested-detector", `struct Inner { a: i32, b: i32 } struct Outer { id: i32, inner: Inner } function bump(own d: Outer): i32 { var u: i32 = d.id + d.inner.a; var c = Outer { id: 5, inner: Inner { a: 7, b: 8 } }; var s: i32 = c.id + c.inner.a + c.inner.b + u; if (s != 23) { return 99; } return __rc_underflow_count(); } function main(): i32 { return bump(Outer { id: 1, inner: Inner { a: 2, b: 3 } }); }`, 0},
		{"own-param-donor-array-corruption-probe-detector", `struct H { id: i32, items: i32[] } function bump(own d: H): i32 { var u: i32 = d.id + d.items[0]; var c = H { id: 5, items: [7, 8, 9] }; var fresh = [11, 22, 33]; var s: i32 = fresh[0] + fresh[1] + fresh[2]; if (c.id + c.items[0] + c.items[2] + u != 32) { return 90; } if (s != 66) { return 91; } return __rc_underflow_count(); } function main(): i32 { return bump(H { id: 1, items: [10, 20] }); }`, 0},
		...
		{"own-param-selfoverwrite-array-detector", `struct H { id: i32, items: i32[] } function bump(own d: H): i32 { var c = H { ...d, items: [7, 8, 9] }; var s: i32 = c.id + c.items[0] + c.items[2]; if (s != 17) { return 99; } return __rc_underflow_count(); } function main(): i32 { return bump(H { id: 1, items: [10, 20] }); }`, 0},
		...
		{"own-param-selfoverwrite-carried-detector", `struct H { id: i32, items: i32[] } function bump(own d: H): i32 { var c = H { ...d, id: 5 }; var s: i32 = c.id + c.items[0] + c.items[1]; if (s != 35) { return 99; } return __rc_underflow_count(); } function main(): i32 { return bump(H { id: 1, items: [10, 20] }); }`, 0},
		{"own-param-selfoverwrite-corruption-probe-detector", `struct H { id: i32, items: i32[] } function bump(own d: H): i32 { var c = H { ...d, items: [7, 8, 9] }; var fresh = [11, 22, 33]; var s: i32 = fresh[0] + fresh[1] + fresh[2]; if (c.id + c.items[0] + c.items[2] != 17) { return 90; } if (s != 66) { return 91; } return __rc_underflow_count(); } function main(): i32 { return bump(H { id: 1, items: [10, 20] }); }`, 0},
		...
		// over-release detector (`__rc_underflow_count()==0`) is the soundness gate for the
		...
		{"enum-reassign-inplace-detector", `enum Bag { Keep(i32[]), Swap(i32[]) } function churn(n: i32): i32 { var b: Bag = Keep([0, 0, 0, 0]); var i = 0; while (i < n) { b = Keep([i, i, i, i]); b = Swap([i, i, i, i]); i = i + 1; } var r = 0; match (b) { Keep(_) => { r = 1; }, Swap(_) => { r = 2; }, } if (r != 2) { return 99; } return __rc_underflow_count(); } function main(): i32 { return churn(5); }`, 0},
