...
func TestSelfHostCheckerCodesX86_64(t *testing.T) {
	...
	cases := []struct {
		...
		{"order-on-string-vars-ok", "function main(): i32 { var a: string = \"a\"; var b: string = \"b\"; if (a >= b) { return 1; } return 0; }\n", nil},
...
func TestSelfHostCheckerDifferentialX86_64(t *testing.T) {
	...
	progs := []struct{ name, src string }{
		...
		{"dyn-set-order-swapped-ok", "trait Shape { function area(self: Self): i32; }\ntrait Named { function name(self: Self): i32; }\nstruct Square { side: i32 }\nimpl Shape for Square { function area(self: Self): i32 { return self.side; } }\nimpl Named for Square { function name(self: Self): i32 { return 2; } }\nfunction main(): i32 { var d: dyn Named + Shape = Square { side: 3 }; var e: dyn Shape + Named = d; return e.area() - 3; }\n"},
		{"tuple-dyn-element-order-swapped-ok", "trait Shape { function area(self: Self): i32; }\ntrait Named { function name(self: Self): i32; }\nstruct Square { side: i32 }\nimpl Shape for Square { function area(self: Self): i32 { return self.side; } }\nimpl Named for Square { function name(self: Self): i32 { return 2; } }\nfunction main(): i32 { var d: dyn Named + Shape = Square { side: 3 }; var t: (dyn Shape + Named, i32) = (d, 2); return t.1; }\n"},
		{"dyn-set-duplicate-trait-ok", "trait Shape { function area(self: Self): i32; }\nstruct Square { side: i32 }\nimpl Shape for Square { function area(self: Self): i32 { return self.side; } }\nfunction main(): i32 { var d: dyn Shape + Shape = Square { side: 3 }; var e: dyn Shape = d; return e.area() - 3; }\n"},
		{"tuple-dyn-element-duplicate-trait-ok", "trait Shape { function area(self: Self): i32; }\nstruct Square { side: i32 }\nimpl Shape for Square { function area(self: Self): i32 { return self.side; } }\nfunction main(): i32 { var d: dyn Shape + Shape = Square { side: 3 }; var t: (dyn Shape, i32) = (d, 2); return t.1; }\n"},
		...
		{"dyn-slot-option-ctor-nonconforming", "trait Shape { function area(self: Self): i32; }\nstruct Square { side: i32 }\nimpl Shape for Square { function area(self: Self): i32 { return self.side; } }\nstruct Other { x: i32 }\nfunction main(): i32 { var o: Option[dyn Shape] = Some(Other { x: 1 }); return 0; }\n"},
		{"dyn-slot-result-ctor-ok", "trait Shape { function area(self: Self): i32; }\nstruct Square { side: i32 }\nimpl Shape for Square { function area(self: Self): i32 { return self.side; } }\nstruct Other { x: i32 }\nfunction main(): i32 { var r: Result[i32, dyn Shape] = Err(Square { side: 1 }); return 0; }\n"},
		{"dyn-slot-user-enum-ctor-nonconforming", "trait Shape { function area(self: Self): i32; }\nstruct Square { side: i32 }\nimpl Shape for Square { function area(self: Self): i32 { return self.side; } }\nstruct Other { x: i32 }\nenum MyOpt[T] { Wrap(T), Empty }\nfunction main(): i32 { var o: MyOpt[dyn Shape] = Wrap(Other { x: 1 }); return 0; }\n"},
		{"dyn-slot-qualified-user-ctor-nonconforming", "trait Shape { function area(self: Self): i32; }\nstruct Square { side: i32 }\nimpl Shape for Square { function area(self: Self): i32 { return self.side; } }\nstruct Other { x: i32 }\nenum MyOpt[T] { Wrap(T), Empty }\nfunction main(): i32 { var o: MyOpt[dyn Shape] = MyOpt.Wrap(Other { x: 1 }); return 0; }\n"},
		{"dyn-slot-qualified-some-nonconforming", "trait Shape { function area(self: Self): i32; }\nstruct Square { side: i32 }\nimpl Shape for Square { function area(self: Self): i32 { return self.side; } }\nstruct Other { x: i32 }\nenum MyOpt[T] { Wrap(T), Empty }\nfunction main(): i32 { var o: Option[dyn Shape] = Option.Some(Other { x: 1 }); return 0; }\n"},
		{"dyn-slot-user-and-qualified-ctors-ok", "trait Shape { function area(self: Self): i32; }\nstruct Square { side: i32 }\nimpl Shape for Square { function area(self: Self): i32 { return self.side; } }\nstruct Other { x: i32 }\nenum MyOpt[T] { Wrap(T), Empty }\nfunction main(): i32 { var o: MyOpt[dyn Shape] = Wrap(Square { side: 1 }); var p: Option[dyn Shape] = Option.Some(Square { side: 1 }); var q: MyOpt[dyn Shape] = MyOpt.Wrap(Square { side: 1 }); return 0; }\n"},
		{"dyn-slot-unused-by-the-variant-ok", "trait Shape { function area(self: Self): i32; }\nstruct Square { side: i32 }\nimpl Shape for Square { function area(self: Self): i32 { return self.side; } }\nstruct Other { x: i32 }\nenum MyOpt[T] { Wrap(T), Empty }\nfunction main(): i32 { var o: MyOpt[dyn Shape] = Empty; var r: Result[i32, dyn Shape] = Ok(1); return 0; }\n"},
		...
		{"dyn-coerce-dyn-to-wider-set", "trait Shape { function area(self: Self): i32; }\nstruct Square { side: i32 }\nimpl Shape for Square { function area(self: Self): i32 { return self.side; } }\nstruct Other { x: i32 }\ntrait Named { function name(self: Self): i32; }\nimpl Named for Square { function name(self: Self): i32 { return 2; } }\nfunction main(): i32 { var a: dyn Shape = Square { side: 1 }; var b: dyn Shape + Named = a; return b.area() - 1; }\n"},
		{"dyn-coerce-dyn-to-narrower-set", "trait Shape { function area(self: Self): i32; }\nstruct Square { side: i32 }\nimpl Shape for Square { function area(self: Self): i32 { return self.side; } }\nstruct Other { x: i32 }\ntrait Named { function name(self: Self): i32; }\nimpl Named for Square { function name(self: Self): i32 { return 2; } }\nfunction main(): i32 { var a: dyn Shape + Named = Square { side: 1 }; var b: dyn Shape = a; return b.area() - 1; }\n"},
		{"dyn-coerce-nonconforming-some", "trait Shape { function area(self: Self): i32; }\nstruct Square { side: i32 }\nimpl Shape for Square { function area(self: Self): i32 { return self.side; } }\nstruct Other { x: i32 }\nfunction main(): i32 { var o: Option[dyn Shape] = Some(Other { x: 1 }); match (o) { Some(s) => { return s.area(); }, None => { return 1; } } }\n"},
		{"dyn-coerce-nonconforming-ok-payload", "trait Shape { function area(self: Self): i32; }\nstruct Square { side: i32 }\nimpl Shape for Square { function area(self: Self): i32 { return self.side; } }\nstruct Other { x: i32 }\nfunction main(): i32 { var r: Result[dyn Shape, string] = Ok(Other { x: 1 }); match (r) { Ok(s) => { return s.area(); }, Err(e) => { return 1; } } }\n"},
		{"dyn-coerce-parametric-impl-ok", "trait Boxed { function b(self: Self): i32; }\nstruct W[T] { v: T }\nimpl[T] Boxed for W[T] { function b(self: Self): i32 { return 1; } }\nfunction main(): i32 { var w: W[i32] = W { v: 1 }; var b: dyn Boxed = w; return b.b() - 1; }\n"},
