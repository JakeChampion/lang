...
func TestARM64TypedLoweringAssembles(t *testing.T) {
	for _, tc := range slices.Concat(armLowerCases, sourceLoopCases, expressionFlowCases, matchFlowCases, tupleMatchCases, voidCallCases, effectFlowCases, cleanupActionCases, iterationCleanupCases) {
