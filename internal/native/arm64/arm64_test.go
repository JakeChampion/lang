...
func TestEncodings(t *testing.T) {
	cases := []struct {
		...
		{"str x0,[sp,#-16]!", arm64.STRpre(0, 31, -16), 0xf81f0fe0},
		{"ldr x0,[sp],#16", arm64.LDRpost(0, 31, 16), 0xf84107e0},
		{"str x1,[x2,#8]!", arm64.STRpre(1, 2, 8), 0xf8008c41},
		{"ldr x3,[x4],#-8", arm64.LDRpost(3, 4, -8), 0xf85f8483},
