...
func TestSelfHostX86Capstone(t *testing.T) {
	...
	dir := t.TempDir()
	for _, name := range []string{"astwalk.fern", "asmcore.fern", "lexer.fern", "parser.fern", "ir.fern", "irlower.fern", "asm_ir.fern", "asm.fern", "asm_run.fern", "util.fern", "wasm.fern", "wasm_run.fern"} {
