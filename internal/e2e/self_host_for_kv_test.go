...
var forKvCases = []struct {
	...
	{"sum-values-built", "function main(): i32 { var m: Map[i32,i32] = map_new(4); m.set(5, 100); m.set(7, 50); var t: i32 = 0; for (k, v) in m { t = t + v; } return t; }", 150},
	{"count", "function main(): i32 { var m: Map[i32,i32] = Map { 1: 0, 2: 0, 3: 0, 4: 0 }; var c: i32 = 0; for (k, v) in m { c = c + 1; } return c + 38; }", 42},
	{"string-keys", "function main(): i32 { var m: Map[string,i32] = map_new(4); m.set(\"a\", 40); m.set(\"b\", 2); var t: i32 = 0; for (k, v) in m { t = t + v; } return t; }", 42},
}
