...
function rep(b: i32, n: i32): string {
    ...
    return string_from_bytes(a);
}
function main(): i32 {
    var ikm: string = rep(11, 22);
    var salt: string = string_from_bytes([0 as u8,1 as u8,2 as u8,3 as u8,4 as u8,5 as u8,6 as u8,7 as u8,8 as u8,9 as u8,10 as u8,11 as u8,12 as u8]);
    var info: string = string_from_bytes([240 as u8,241 as u8,242 as u8,243 as u8,244 as u8,245 as u8,246 as u8,247 as u8,248 as u8,249 as u8]);
    ...
    var e: string = string_from_bytes([]);
