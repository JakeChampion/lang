...
func TestSelfHostAsmRunX86_64(t *testing.T) {
	...
	cases := []struct {
		...
		{
			"str-reverse-single",
			"function main(): i32 { var s = \"x\"; print(s.reverse()); return 0; }",
			0,
			"x",
			"",
		},
		...
		{
			"str-lines-content",
			"function main(): i32 { var s = \"foo\\nbar\"; var ls = s.lines(); for l in ls { print(l); print(\"|\"); } return 0; }",
			0,
			"foo|bar|",
			"",
		},
		...
		{
			"str-chars-content",
			"function main(): i32 { var s = \"abc\"; var cs = s.chars(); for c in cs { print(c); print(\"|\"); } return 0; }",
			0,
			"a|b|c|",
			"",
		},
		...
		{
			"str-chars-index",
			"function main(): i32 { var s = \"xyz\"; var cs = s.chars(); print(cs[1]); return 0; }",
			0,
			"y",
			"",
		},
