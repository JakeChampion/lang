...
function main(): i32 {
    ...
    if (crypto.hmac_sha256_hex("key", "The quick brown fox jumps over the lazy dog") != "f7bc83f430538424b13298e6aa6fb143ef4d59a14946175997479dbc2d1a3cd8") { return 4; }
    // HMAC-SHA256 with a >64-byte key (exercises the key-is-hashed-first path).
    if (crypto.hmac_sha256_hex("this-is-a-deliberately-long-hmac-key-exceeding-sixty-four-bytes-so-it-gets-hashed-first", "message") != "1c4000eb3d7dcdf15f3891fcffeb65b69d9d3dc114306505c3b2343cfdb08edd") { return 5; }
    return 0;
}
`
