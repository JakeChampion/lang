...
func TestCmdLangComponentWrapCliWithTcpServer(t *testing.T) {
	...
	build := func(name, src string) string {
		...
		cmd := exec.Command("go", "run", "./cmd/fern", "-target", "wasm", "-emit", "core-module", "-component-wrap-cli", "-o", compPath, srcPath)
...
function main(): i32 {
	...
	build := exec.Command("go", "run", "./cmd/fern", "-target", "wasm", "-emit", "core-module", "-component-wrap-cli", "-o", compPath, srcPath)
...
func TestCmdLangComponentWrapCliWithReadFile(t *testing.T) {
	...
	mc := exec.Command("go", "run", "./cmd/fern", "-target", "wasm", "-emit", "core-module", "-component-wrap-cli", "-o", missComp, miss)
