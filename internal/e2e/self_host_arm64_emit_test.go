...
func TestSelfHostAsmArm64Bootstrap(t *testing.T) {
	...
	cases := []struct {
		...
		{
			"arr-i32-push-len",
			"function main(): i32 { var xs: i32[] = [1, 2, 3]; xs = xs.push(4); return len(xs); }",
			4,
			"",
		},
		{
		...
		{
			"arr-string-push",
			"function main(): i32 { var xs: string[] = [\"a\", \"b\"]; xs = xs.push(\"c\"); for s in xs { print(s); } return len(xs); }",
			3,
			"abc",
		},
		{
		...
		},
		{
			...
			"function main(): i32 { var s = \"a,b,c\"; var parts = s.split(\",\"); return len(parts); }",
			3,
			"",
		},
		{
		...
		{
			"str-method-trim",
			"function main(): i32 { var s = \"  hi  \"; var t = s.trim(); print(t); return len(t); }",
			2,
			"hi",
		},
		{
		...
		},
		{
			...
			"function main(): i32 { var xs: i32[] = []; var ys = xs.reverse(); return len(ys); }",
			0,
			"",
		},
		{
		...
		{
			"i32-dot-to-string",
			"function main(): i32 { var n: i32 = 42; var s = n.to_string(); print(s); return len(s); }",
			2,
			"42",
		},
		{
		...
		},
		{
			...
			"function main(): i32 { var n: i32 = 0 - 7; var s = n.to_string(); print(s); return len(s); }",
			2,
			"-7",
		},
		{
			"string-dot-to-string-identity",
			"function main(): i32 { var s = \"hi\"; var t = s.to_string(); print(t); return len(t); }",
			2,
			"hi",
		},
		{
		...
		{
			"str-to-upper-basic",
			"function main(): i32 { var u = str_to_upper(\"hello\"); print(u); return len(u); }",
			5,
			"HELLO",
		},
		{
		...
		{
			"str-to-lower-basic",
			"function main(): i32 { var l = str_to_lower(\"HELLO\"); print(l); return len(l); }",
			5,
			"hello",
		},
		{
		...
		{
			"str-to-upper-empty",
			"function main(): i32 { return len(str_to_upper(\"\")); }",
			0,
			"",
		},
		{
