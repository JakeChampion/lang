...
func TestSelfHostAsyncCombinatorsModloadIRX86_64(t *testing.T) {
	...
	for _, name := range []string{"util.fern", "astwalk.fern", "asmcore.fern", "flatten.fern", "checker.fern", "ir.fern", "irlower.fern", "asm_ir.fern", "asm.fern", "treeshake.fern", "asm_arm64.fern", "asm_arm64_ir.fern", "asm_load_run.fern"} {
